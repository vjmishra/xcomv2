...
var mandatoryFieldErrorList = [
                     		...
                     		{"id": "Name", "display": "You must enter a name for this list, please enter a name and try again."},
                     		{"id": "Item #", "display": "You must enter an item number, please enter an item number and try again."}
                     	 ];
