...
<s:if
	...
	<div id="miniCartLinkDiv" class="shopping-cart-1"><s:action
		name="miniCartLinkDisplay" namespace="/order" executeResult="true" />
	</div>
	<div id="miniCartDiv" class="expanded-mini-cart"></div>
	<div style='display: none;'><s:form name='miniCartForm'
		...
		<s:hidden id='miniCartTitle'
			value='%{#_action.getText("ShoppingCart")}' />
	</s:form> <s:url id='miniCartLinkDisplayURL' namespace='/order'
		action='miniCartLinkDisplay' /> <s:if
