...
<head>
<!-- Webtrend tag starts -->
<meta name="WT.ti" content="GSM Calculator">
<!-- Webtrend tag stops --> 
<!-- styles -->
...
<script type="text/javascript" src="../../xpedx/js/gsm.js" language="javascript"> </script>

<script type="text/javascript" src="/swc/xpedx/js/jquery-ui.min.js"></script>

<title><s:text name="tools.gsmcalculator.title" /></title>
</head>
