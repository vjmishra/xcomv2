...
public class XPEDXImpositionCalculator extends WCMashupAction {
	...
	public String getCalculation() {
		...
		List<Map<String, String>> numoutWasteList = XPEDXComputeImposition.calcPage(getSheetSizeW(), getSheetSizeH(), getTrimSizeW(), 
				getTrimSizeH(), getGripperWidth(), getColorBarWidth(), getSideGuide(), getGutter());
	...
	public String getPageDetails() {
		...
		List<Map<String, String>> numWastList = XPEDXComputeImposition.calcPage(getSheetSizeW(), getSheetSizeH(), getTrimSizeW(), 
				getTrimSizeH(), getGripperWidth(), getColorBarWidth(), getSideGuide(), getGutter());
		...
		wcContext.setWCAttribute("pageDetail", pageOutput, WCAttributeScope.REQUEST);
