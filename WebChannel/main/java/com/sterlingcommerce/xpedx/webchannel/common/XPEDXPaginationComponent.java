...
public class XPEDXPaginationComponent extends Component
{
 ...
 private void printRootElementOpen(Writer out, String id, String cssClass)
     throws IOException
 {
     out.append("<span");
     if(id != null)
 ...
 private void printRootElementClose(Writer out)
     throws IOException
 {
     out.append("</span>");
 }

 private void printPageRef(Writer out, boolean makeLink, String urlSpec, int pageNumber)
     throws IOException
 {
     printPageRef(out, makeLink, urlSpec, pageNumber, (new StringBuilder()).append("").append(pageNumber).toString());
 }

 private void printPageRef(Writer out, boolean makeLink, String urlSpec, int pageNumber, String label)
     throws IOException
 {
     if(makeLink && urlSpec != null)
     {
         String url = MessageFormat.format(urlSpec, new Object[] {
             Integer.valueOf(pageNumber)
         });/*
         String html="<script>"+
         			"function callAjaxForPagination()"+
	         		"{"+
...
private String getText(String key)
 ...
 private static final String LAST_TEXT = "last";
