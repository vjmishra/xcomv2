...
<%-- 				  <div id="breadcumbs-list-name" class="page-title"><s:a href="%{toolsLink}">Tools</s:a> /  <s:a href="%{toolsNewsMaintLink}"> News Maintenance</s:a> /  <span class="breadcrumb-inactive">  New Article</span> <a href="#"><span class="print-ico-xpedx"><img src="/swc/xpedx/images/common/print-icon.gif" width="16" height="15" alt="Print This Page" />Print Page</span></a>     </div> --%>
...
<%-- 		          <div>
		        ...
		        <!--     <div class="error" id="errorMsgFor_articleTitle" style="display : none">You can't have two article with same "Article Title". Please give a different name.</div> -->				    
		            ...
		            <tr>
		              <td  colspan="4"><textarea  name="articleBody" id="articleBody" rows="20" class="ckeditor x-input article-textarea" style="width:815px;" maxlength="2000" onkeyup="return ismaxlength(this)"></textarea></td>
<!-- 		              cols="9"  -->
		            </tr>		            
		            <tr>
		              <td colspan="4">
