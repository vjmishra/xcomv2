...
<div align="center"> <s:text name="MSG.SWC.ADMN.PRFU.GENERIC.NOSHIPTO" /> </div>
</s:if>
<s:else>
...
<div class="right">
	<input type='checkbox' name="setAsDefault" id="setAsDefault" class="change-preferred-ship-to" />bb3Change Preferred Ship-To to Selected
</div>
