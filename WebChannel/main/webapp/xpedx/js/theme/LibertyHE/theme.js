...
//            margin: 1,
    ...
    decorateBoxes:function() {
        var rules = "";
        var listTableContent='.panel-n-bg-bottom,.contentLeftBottom';// "contentLeftBottom" is for asset in home page
...
//        rules+=".sign-in {background-color: transparent; }\n";
        ...
        rules+=SVGAnnotator.mkGeneralShapeRuleSet('.t4-prom-content', {//"t4-prom-content" is for asset in home page
            ...
            fillGradientTargetColor:'#ffffff',
            dropShadowOffsetX:1,
            dropShadowOffsetY:1,
            dropShadowOpacityPct:50,
            outsideOpacityPct:0
