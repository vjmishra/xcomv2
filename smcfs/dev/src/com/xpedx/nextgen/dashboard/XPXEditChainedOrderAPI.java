...
public class XPXEditChainedOrderAPI implements YIFCustomApi {
	...
	static {
		...
		log = YFCLogCategory.instance(XPXEditChainedOrderAPI.class);
		try {
		...
		try {						
			if(inXML != null) {
				...
				if(editOrdLinesEle != null) {
					YFCIterable yfcItr = editOrdLinesEle.getChildren("OrderLine");
					while(yfcItr.hasNext()) {
						...
						if(editOrdLineExtnEle != null) {
							if(editOrdLineExtnEle.hasAttribute("ExtnLegacyLineNumber")) {
								legacyLineNo = editOrdLineExtnEle.getAttribute("ExtnLegacyLineNumber");
							}
						...
						if(!YFCObject.isNull(action) && !YFCObject.isVoid(action)) {
							if(!action.equalsIgnoreCase("CREATE")) {
								if(!YFCObject.isNull(editOrdLineKey) && !YFCObject.isVoid(editOrdLineKey)) {
									...
									// Do Nothing
								} else if(!ordType.equalsIgnoreCase("Customer") && !YFCObject.isNull(webLineNo) && 
										!YFCObject.isVoid(webLineNo) && !YFCObject.isNull(legacyLineNo) && !YFCObject.isVoid(legacyLineNo)) {
									// Do Nothing
								} else {
									throw new Exception("One or More Mandatory Attributes[Action='CREATE', OrderLineKey, (WebLineNo,LegacyLineNo), OrderType] Not Availble in Incoming Edit Message!");
								}
							}
				...
				processOrderEdit(env, ordType, webConfNum, legOrdNum, cOrdHeaderKey, fOrdHeaderKey, editOrdEle, cAndfOrdListEle);
	...
	private Document processOrderEdit(YFSEnvironment env, String ordType, String webConfNum, String legOrdNum, String cOrdHeaderKey, String fOrdHeaderKey, YFCElement editOrdEle, YFCElement cAndfOrdListEle) throws Exception {
		
		try {
			Map chngfOrders = null;
			...
			if(ordType.equalsIgnoreCase("Customer")) {
				...
				chngfOrders = prepareChngfOrder(env, editOrdEle, fOrderEle, cAndfOrdListEle, buyerOrgCustEle);
			}
			...
			for(int i=0; i < chngfOrdersArray.length; i++) {
				...
				if(chngfOrdersArray[i].equalsIgnoreCase("CC") || chngfOrdersArray[i].equalsIgnoreCase("CA")) {
					...
					if(chngfOrdEle != null) {
						...
						boolean hasLegacyOrdNo = true;
						YFCElement chngfOrdExtnEle = chngfOrdEle.getChildElement("Extn");
						if(chngfOrdExtnEle != null) {
							if(chngfOrdExtnEle.hasAttribute("ExtnLegacyOrderNo")) {
								String legacyOrdNo = chngfOrdExtnEle.getAttribute("ExtnLegacyOrderNo");
								if(YFCObject.isNull(legacyOrdNo) || YFCObject.isVoid(legacyOrdNo)) {
									hasLegacyOrdNo = false;
								}
							} else {
								hasLegacyOrdNo = false;
							}
						} else {
							throw new Exception("Element Order/Extn Not Available in Edit Order Message!");
						}
						...
						Map retDocMap = processOrderEditC(env, chngfOrdEle, fOrderEle, cOrderEle);
						if(retDocMap != null) {
							if(retDocMap.size() > 0) {
								...
								if(foDocEle != null) {
									...
									if(hasLegacyOrdNo) {
										setDefaultPC(postToLegacyOrdEle, "C");
									} else {
										setDefaultPC(postToLegacyOrdEle, "A");
									}
				...
				if(chngfOrdersArray[i].equalsIgnoreCase("AA")) {
					...
					if(chngfOrdEle != null) {
						validateWebHoldFlag(chngfOrdEle, buyerOrgCustEle);
						Map retDocMap = processOrderEditA(env, chngfOrdEle, fOrderEle, cOrderEle, buyerOrgCustEle);
						if(retDocMap != null) {
							if(retDocMap.size() > 0) {
								YFCElement foDocEle = (YFCElement)retDocMap.get("FO");
								if(foDocEle != null) {
				...
				if(postEditMsgToLegacy) {
					...
					if(postToLegacyOrdEle.hasAttribute("IsValidOrder")) {
						...
						if(editOrdMsgFromLegacy != null) {
							...
							YFCNodeList nodeListEle = editOrdMsgFromLegacyEle.getElementsByTagName("TransactionStatus");
	...
	private void filterCancelLines(YFCElement legacyOrdEle) throws Exception {
		...
		if(legacyOrdLinesEle != null) {
			YFCIterable yfcItr = legacyOrdLinesEle.getChildren("OrderLine");
			while(yfcItr.hasNext()) {
				YFCElement legacyOrdLineEle = (YFCElement) yfcItr.next();
				if(legacyOrdLineEle != null) {
					String _ordLineKey = null;
					if(legacyOrdLineEle.hasAttribute("OrderLineKey")) {
						_ordLineKey = legacyOrdLineEle.getAttribute("OrderLineKey");
					...
					boolean isEmptyLegLineNo = false;
					YFCElement legacyOrdLineExtnEle = legacyOrdLineEle.getChildElement("Extn");
					if(legacyOrdLineExtnEle != null) {
						if(legacyOrdLineExtnEle.hasAttribute("ExtnLegacyLineNumber")) {
							String legLineNo = legacyOrdLineExtnEle.getAttribute("ExtnLegacyLineNumber");
							if(YFCObject.isNull(legLineNo) || YFCObject.isVoid(legLineNo)) {
								isEmptyLegLineNo = true;
							}
						} else {
							isEmptyLegLineNo = true;
						}
					...
					if(isEmptyLegLineNo && isCancelLine) {
	...
	private void validateWebHoldFlag(YFCElement chngfOrdEle, YFCElement buyerOrgCustEle) {
		...
		YFCElement chngfOrdExtnEle = chngfOrdEle.getChildElement("Extn");
		if(chngfOrdExtnEle != null) {
			YFCNodeList instructionList = chngfOrdEle.getElementsByTagName("Instruction");
			Iterator itr = instructionList.iterator();
			while(itr.hasNext()) {
	...
	private void setDefaultPC(YFCElement fOrderEle, String pc) throws Exception {
		
		YFCElement fOrdLinesEle = fOrderEle.getChildElement("OrderLines");
		if(fOrdLinesEle != null) {
			YFCIterable yfcItr = fOrdLinesEle.getChildren("OrderLine");
			while(yfcItr.hasNext()) {
				...
				if(pc.equalsIgnoreCase("C")) {
					...
					String legLineNum = null;
					YFCElement fOrdLineExtnEle = fOrdLineEle.getChildElement("Extn");
					if(fOrdLineExtnEle.hasAttribute("ExtnLegacyLineNumber")) {
						legLineNum = fOrdLineExtnEle.getAttribute("ExtnLegacyLineNumber");
						if(YFCObject.isNull(legLineNum) || YFCObject.isVoid(legLineNum)) {
							fOrdLineEle.setAttribute("LineProcessCode", "A");
						}
					} else {
						fOrdLineEle.setAttribute("LineProcessCode", "A");
	...
	private Map processOrderEditC(YFSEnvironment env, YFCElement editOrderEle, YFCElement fOrderEle, YFCElement cOrderEle) throws Exception {
		...
		Map chnOrdCrtMap = this.getChainedOrderCreatedQtyOnCO(chngcOrdStatusEle0);
		this.adjustChainedOrderCreatedQtyOnCO(chngcOrderEle1, chnOrdCrtMap);
		
		// Updates customer and fulfillment order.
		Map retDocMap = updatefOrder(env, chngcOrderEle0, chngcOrdStatusEle0, chngcOrdStatusEle1, editOrderEle, chngcOrderEle1, cOrderEle, fOrderEle);
		
		return retDocMap; 

	}
	
	private Map getChainedOrderCreatedQtyOnCO(YFCElement chngcOrdStatusEle0) throws Exception {
		Map newQtyMap = new HashMap();
		if(chngcOrdStatusEle0.hasAttribute("OrderHeaderKey")) {
			...
			YFCIterable yfcItr = chngcOrdLinesStatusEle0.getChildren("OrderLine");
			while(yfcItr.hasNext()) {
	...
	private void adjustChainedOrderCreatedQtyOnCO(YFCElement chngcOrderEle1, Map chnOrdCrtMap) throws Exception {
		if(chngcOrderEle1.hasAttribute("OrderHeaderKey")) {
			YFCElement chngcOrdLinesEle1 = chngcOrderEle1.getChildElement("OrderLines");
			YFCIterable yfcItr = chngcOrdLinesEle1.getChildren("OrderLine");
			while(yfcItr.hasNext()) {
	...
	private Map processOrderEditA(YFSEnvironment env, YFCElement editOrderEle, YFCElement fOrderEle, YFCElement cOrderEle, YFCElement buyerOrgCustEle) throws Exception {
		Map retDocMap = new HashMap();
	...
	private Map prepareChngfOrderFromcOrder(YFSEnvironment env, YFCElement editOrdEle, YFCElement cOrderEle, YFCElement cAndfOrdListEle, YFCElement buyerOrgCustEle) throws Exception {
		
		Map chngfOrders = new HashMap();
	...
	private void preparefOrders(YFCElement editOrdEle, YFCElement editOrdLineEle, YFCElement cAndfOrdListEle, Map tempMap, Map chngfOrders) throws Exception {
				...
				if(editOrdLineExtnEle != null) {
					if(editOrdLineExtnEle.hasAttribute("ExtnWebLineNumber")) {
						...
						if(YFCObject.isNull(webLineNo) || YFCObject.isVoid(webLineNo)) {
							throw new Exception("One or More Mandatory Attributes[OrderLineKey, (WebLineNo,LegacyLineNo)] Not Availble in Incoming Edit Message!");
						}
					}
				} else {
	...
	private Map prepareChngfOrder(YFSEnvironment env, YFCElement editOrdEle, YFCElement fOrderEle, YFCElement cAndfOrdListEle, YFCElement buyerOrgCustEle) throws Exception {
		...
		if(chngfOrdLinesEle0 != null) {
			YFCIterable yfcItr = chngfOrdLinesEle0.getChildren("OrderLine");
			while(yfcItr.hasNext()) {
	...
	private YFCElement getfOrderEle(String ordHeaderKey, YFCElement cAndfOrdListEle) throws Exception {
		...
		YFCIterable yfcItr = cAndfOrdListEle.getChildren("Order");
		while(yfcItr.hasNext()) {
	...
	private Map updatefOrder(YFSEnvironment env, YFCElement chngcOrderEle0, YFCElement chngcOrdStatusEle0, YFCElement chngcOrdStatusEle1, YFCElement chngfOrderEle, YFCElement chngcOrderEle1, YFCElement cOrderEle, YFCElement fOrderEle) throws Exception {
		Map retDocMap = new HashMap();
		...
		if(chngcOrderEle0.hasAttribute("OrderHeaderKey")) {
			...
			tempDoc = this.api.executeFlow(env, "XPXChangeOrder", chngcOrderEle0.getOwnerDocument().getDocument());
			if(tempDoc != null) {
		...
		if(chngcOrdStatusEle1.hasAttribute("OrderHeaderKey")) {
			...
			tempDoc = this.api.executeFlow(env, "XPXChangeOrderStatus", chngcOrdStatusEle1.getOwnerDocument().getDocument());
			if(tempDoc == null) {
				throw new Exception("Service XPXChangeOrderStatus Failed!");
			}
		}
		...
		if(chngcOrderEle1.hasAttribute("OrderHeaderKey")) {
			...
			tempDoc = this.api.executeFlow(env, "XPXChangeOrder", chngcOrderEle1.getOwnerDocument().getDocument());
			if(tempDoc != null) {
				cOrderEle = YFCDocument.getDocumentFor(tempDoc).getDocumentElement();
			} else {
				throw new Exception("Service XPXChangeOrder Failed!");
	...
	private void preparefOChange(YFSEnvironment env, YFCElement chngcOrderEle0, YFCElement chngcOrderEle1, YFCElement chngcOrdStatusEle0, YFCElement chngcOrdStatusEle1, YFCElement editOrdEle, YFCElement fOrderEle, YFCElement cOrderEle) throws Exception {
							...
							if(!action.equalsIgnoreCase("CREATE")) {
								if(!YFCObject.isNull(editOrdLineKey) && !YFCObject.isVoid(editOrdLineKey)) {
									fOrdLineKey = editOrdLineKey;
											...
											!YFCObject.isNull(legacyLineNo) && !YFCObject.isVoid(legacyLineNo)) {
									fOrdLineKey = getOrderLineKeyForWebLineNo(webLineNo, legacyLineNo, fOrderEle);
								} else {
						...
						if(lineProcessCode.equalsIgnoreCase("A")) {						
							if(YFCObject.isNull(fOrdLineKey) || YFCObject.isVoid(fOrdLineKey)) {
								if(YFCObject.isNull(cOrdLineKey) || YFCObject.isVoid(cOrdLineKey)) {
									...
									this.handleLineProcessCodeCandA(cOrdHeaderKey, cOrdLineKey, action, fOrdLineKey, webLineNo, legacyLineNo, editOrdLineEle, fOrderEle, cOrderEle,	chngcOrdStatusEle0, chngcOrdStatusEle1, chngcOrderEle0, chngcOrderEle1);
	...
	private void handleLineProcessCodeCandA(String cOrdHeaderKey, String cOrdLineKey, String action, String fOrdLineKey, String webLineNo, String legacyLineNo, YFCElement editOrdLineEle, YFCElement fOrderEle, YFCElement cOrderEle, YFCElement chngcOrdStatusEle0, YFCElement chngcOrdStatusEle1, YFCElement chngcOrderEle0, YFCElement chngcOrderEle1) throws Exception {
		...
		if(!YFCObject.isNull(action) && !YFCObject.isVoid(action)) {
			if(!action.equalsIgnoreCase("CREATE")) {
				if(!YFCObject.isNull(fOrdLineKey) && !YFCObject.isVoid(fOrdLineKey)) {
					List ordLineKeys = this.getOrdLineKeysToArray(fOrderEle);
		...
		System.out.println("legacyLineNo:"+legacyLineNo);
		...
		if(!isNewFOLine) {
			if(!YFCObject.isNull(fOrdLineKey) && !YFCObject.isVoid(fOrdLineKey)) {
				String tempQty = this.getOrderedQtyOnOrderLine(fOrdLineKey, fOrderEle);
				...
				String tempQty = this.getOrderedQtyOnOrderLine(webLineNo, legacyLineNo, fOrderEle);
				if(YFCObject.isNull(tempQty) || YFCObject.isVoid(tempQty)) {
					throw new Exception("OrderedQty on OrderLine Cannot be NULL or Void!");
				}
				_ordLineQtyInFO = Float.parseFloat(tempQty);
	...
	private YFCElement getOrderLineFromChngcOrdStatusEle(YFCElement chngcOrdStatusEle, String cOrdLineKey) {
		if(chngcOrdStatusEle.hasAttribute("OrderHeaderKey")) {
			...
			if(chngcOrdLinesStatusEle != null) {
				YFCIterable yfcItr = chngcOrdLinesStatusEle.getChildren("OrderLine");
				while(yfcItr.hasNext()) {
	...
	private YFCElement getOrderLineFromChngcOrdEle(YFCElement chngcOrderEle, String cOrdLineKey) {
		if(chngcOrderEle.hasAttribute("OrderHeaderKey")) {
			YFCElement chngcOrdLinesEle = chngcOrderEle.getChildElement("OrderLines");
			if(chngcOrdLinesEle != null) {
				YFCIterable yfcItr = chngcOrdLinesEle.getChildren("OrderLine");
				while(yfcItr.hasNext()) {
	...
	private YFCDocument updateCustomerOrder(YFSEnvironment env, YFCElement chngcOrdEle, YFCElement cOrderEle) throws Exception {
		...
		List alreadyModifiedWebLineNoList = new ArrayList();
					...
					if(chngcOrdLineExtnEle.hasAttribute("ExtnWebLineNumber")) {
						...
						if(webLineNosExistingCO.contains(webLineNo)) {
							...
							if(!alreadyModifiedWebLineNoList.contains(webLineNo)) {
								String cOrdLineKey = this.getOrderLineKeyForWebLineNo(webLineNo, null, cOrderEle);
								if(YFCObject.isNull(cOrdLineKey) || YFCObject.isVoid(cOrdLineKey)) {
									throw new Exception("Attribute OrderLineKey Cannot be NULL or Void!");
								}
								
								String ordQtyInCO = getOrderedQtyOnOrderLine(webLineNo, null, cOrderEle);
		...
		Document tempDoc = this.api.executeFlow(env, "XPXChangeOrder", chngcOrdEle.getOwnerDocument().getDocument());
		if(tempDoc != null) {
	...
	private String getOrderedQtyOnOrderLine(String ordLineKey, YFCElement orderEle) throws Exception {
	...
	private YFCDocument createFulfillmentOrder(YFSEnvironment env, YFCElement editOrdEle, YFCElement cOrderEle) throws Exception {
		...
		// To create fulfillment order.
		Document tempDoc = this.api.executeFlow(env, "XPXCreateOrder", editOrdEle.getOwnerDocument().getDocument());
		if(tempDoc != null) {
			return YFCDocument.getDocumentFor(tempDoc);
		} else {
	...
	private List getWebLineNosToArray(YFCElement editOrdEle) throws Exception {
	...
	private List getOrdLineKeysToArray(YFCElement ordEle) throws Exception {
		
		List ordLineKeyArray = new ArrayList();
		YFCElement ordLinesEle = ordEle.getChildElement("OrderLines");
		if(ordLinesEle != null) {
			YFCIterable yfcItr = ordLinesEle.getChildren("OrderLine");
			while(yfcItr.hasNext()) {
	...
	private String getChainedFromOrderKeys(String ordLineKey, YFCElement cAndfOrdListEle) throws Exception {
		...
		YFCIterable yfcItr0 = cAndfOrdListEle.getChildren("Order");
