...
public class XPXShowListOfShipToPanel extends XPXPaginationComposite implements IYRCComposite {

	private Composite pnlRoot = null;
    private XPXShowListOfShipToPanelBehavior myBehavior;
	private Element elePageInput;
	private Group pnlResults;
	Table tblResults;
	public Element eleSelected;
	private String isMil;
    public static final String FORM_ID = "com.xpedx.sterling.rcp.pca.sharedTasks.shiptolookup.XPXShowListOfShipToPanel";

	public XPXShowListOfShipToPanel(Composite parent, int style, Element inputObject) {
		super(parent, style);
		elePageInput = (Element) inputObject;
		isMil = elePageInput.getAttribute("MIL");
		initialize();
		setBindingForComponents();
        myBehavior = new XPXShowListOfShipToPanelBehavior(this, FORM_ID, elePageInput);
	}
    ...
    private void setBindingForComponents() {
        ...
        colBindings[0].setAttributeBinding("ShipToCustomerID");
        colBindings[0].setColumnBinding("Customer_ID");
        colBindings[0].setSortReqd(true);   
        colBindings[1] = new YRCTblClmBindingData();
        colBindings[1].setAttributeBinding("@AddressLine1;@AddressLine2;@AddressLine3;@City;@State;@Country;@ZipCode");
        colBindings[1].setColumnBinding("Address");
        colBindings[1].setKey("xpedx_address_key");
	...
	private void createPnlResults() {
		...
		createTblResults();
		super.createPaginationLinks(pnlResults, XPXShowListOfShipToPanelBehavior.PAGINATION_STRATEGY_FOR_SEARCH);
	}
	private void createPnlTitleHolder() {
		XPXUtils.addGradientPanelHeader(pnlResults, "ShipToLocations", true);
	}
