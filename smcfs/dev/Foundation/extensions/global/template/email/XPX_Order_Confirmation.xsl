							...
							<tr>
								<td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">
									<table width="" border="0">
										...
										<tr>
											<td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">
												Thank you for shopping at  <xsl:value-of select="Order/@SellerOrganizationCode"/>.com. Please review the details of your order below.                 
												<span ></span>
												<a href="{$storeFrontURL}" style="color:#000;">Click Here</a> to review this order on 
													<xsl:value-of select="Order/@SellerOrganizationCode"/>.com.		
											</td>
										</tr>
										<tr>
