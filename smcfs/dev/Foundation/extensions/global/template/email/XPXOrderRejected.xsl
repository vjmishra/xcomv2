  ...
  <tr>
      ...
      <tr>
        <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><table width="" border="0">
          ...
          <tr>
            <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">This email is to inform you this order has been rejected. Please review all of the information to make sure the order is correct. <a href="#" style="color:#000;">Click Here</a> to review this order on <xsl:value-of select="@EnterpriseCode"/>.com </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><table width="100%" border="0">
              ...
              <tr>
                ...
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">Rejected</td>
              ...
              <tr>
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">Reason Comment:</td>
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><xsl:value-of select="./Extn/@ExtnOrdStatCom"/></td>
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></td>
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><xsl:text disable-output-escaping="yes">&amp;nbsp;</xsl:text></td>
              </tr>
