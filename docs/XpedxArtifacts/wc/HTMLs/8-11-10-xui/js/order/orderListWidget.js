...
function sliderOrderListWidget(elementId, imgElementId, showImgClass, hideImgClass, isDisplayed){
...
Ext.onReady(function() {
    sliderOrderListWidget('orderListWidget','toggleList','sliderIn','sliderOut', true);
});
