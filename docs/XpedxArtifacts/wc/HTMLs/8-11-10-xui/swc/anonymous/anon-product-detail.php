...
<div id="main-container">
    <div id="main" class="anon-pages">
        <?php include '../includes/anon-header.php'; ?>
            <div class="container">
                ...
                <div class="prod_detail">
                    ...
                    <div class="prod_detail_rpt">
                        <div class="anon-right-prod-detail">
                        ...
                        <div class="avail-update">
                            <div class="avail-grid">
                                <div id="tabs">
                                    ...
                                    <div id="tabs-1">
                                    	<div class="float-right" style="width: 180px; margin-left:10px;">
                                        	<p style="font-size: 12px;">Provide information or links to additional product information. E.g., environmental rating.</p>
                                        	<img class="green-e-prod" align="right" title="Green-e Logo"  alt="Green-e Logo" src="../../images/catalog/products/green-e-logo.jpg" />
                                        </div>
                                        <table id="prod-details-tbl" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr class="odd int-deets">
                                                <td>Base unit of measure (UOM)</td>
                                                <td>Sheet</td>
                                            </tr>
                                            <tr class="int-deets">
                                                <td>Packaging</td>
