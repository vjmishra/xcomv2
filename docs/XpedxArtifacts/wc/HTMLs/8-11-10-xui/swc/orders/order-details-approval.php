...
<title>xpedx / Orders Details Approval</title>
</head>
<!-- END swc:head -->
...
<div id="main-container">
    <div id="main">
        <?php include '../includes/header.php'; ?>
            <div class="container">
                <!-- breadcrumb -->
                <div id="breadcumbs-list-name"> <a href="#">Home</a> / <span class="breadcrumb-inactive">Order Details for Web Order Y1001</span> <a href="#"> <span class="print-ico-xpedx"><img src="../../images/common/print-icon.gif" width="16" height="15" alt="Print This Page" />Print Page</span></a> </div>
                <div id="mid-col-mil"><br />
                    <h2> Web Confirmation Number: Y1001 </h2>
                    <p class="boldText"> Order Number: Not Available </p>
                    <p class="boldText">Order Status: <span class="red"> Pending Approval </span> </p>
                    <p class="boldText red">Order exceeds [$ Amount]</p>
                    <div class="clearall"></div>
                    <p> <a href="#" class="grey-ui-btn"><span> Return to Approvals</span></a></p>
                    <p class="float-right-order"> <a href="#" class="grey-ui-btn"><span>Approve</span></a></p>
                    <p class="float-right-order"> <a href="#" class="grey-ui-btn"><span>Reject</span></a></p>
                    <p class="float-right-order"> <a href="#" class="grey-ui-btn"><span>Edit Order</span></a></p>
                    <br />
                    <br />
 ...
 <td valign="top" align="left">
  ...
  <td valign="top"><p>Customer PO:</p>
                    ...
                    <div id="order-btm-left">
                        <div id="selected-items-manager"> <br />
                    ...
                    <ul class="tool-bar-top" id="tool-bar">
                        <li><a href="#" class="grey-ui-btn"><span>Return to Approvals</span></a></li>
                        <li style="float: right;"><a href="#" class="grey-ui-btn"><span>Approve</span></a></li>
                        <li style="float: right;"><a href="#" class="grey-ui-btn"><span>Reject</span></a></li>
                        <li style="float: right;"><a href="#" class="grey-ui-btn"><span>Edit Order</span></a></li>
                    </ul>
                    <!-- end totals -->
                </div>
            </div>
