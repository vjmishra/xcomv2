  ...
  <div id="main">
    <?php include '../includes/header.php'; ?>
      <div class="container"> 
        ...
        <!-- breadcrumb -->
        <div id="breadcumbs-list-name"> <a href="#">Orders</a> / <span class="breadcrumb-inactive">Recent Orders</span> <a href="#"> <span class="print-ico-xpedx"><img src="../../images/common/print-icon.gif" width="16" height="15" alt="Print This Page" />Print This Page</span></a> </div>
    ...
    <td>&nbsp;</td>
          ...
          <table id="mil-list" style="background:none;" width="951" border="0">
            ...
            <tr>
              ...
              <td><a href="recent-orders-split.php">Split Order</a></td>
              <td>8674-98</td>
              <td>03/05/10</td>
              <td>Johnson,J</td>
              <td><div>
