...
<title>xpedx / Legacy Orders</title>
</head>
<!-- END swc:head -->
...
<div id="main-container">
    <div id="main">
        <?php include '../includes/header.php'; ?>
            <div class="container">
                <!-- breadcrumb -->
                <div id="breadcumbs-list-name"> <a href="#">Orders</a> / <span class="breadcrumb-inactive">Order Details for Order 12345-00</span> <a href="#"> <span class="print-ico-xpedx"><img src="../../images/common/print-icon.gif" width="16" height="15" alt="Print This Page" />Print Page</span></a> <a href="#"> <span class="print-ico-xpedx"><img src="../../images/common/email-icon.gif" width="16" height="15" alt="Print This Page" />Email Page</span></a> </div>
                <div id="mid-col-mil"><br />
                    <h2> Order Number: 12345-00 </h2>
                    <p class="boldText"> Web Confirmation Number: Y12345</p>
                    <p class="boldText">Order Status: Open </p>
                    <p>Invoice: <a href="#">Order # 69393854</a></p>
                 ...
                 <table id="x-tbl-cmmn">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td valign="top" align="left"><p class="txt-grey-1"><strong>You will receive your order on your normal delivery schedule unless you select a different shipping option below:</strong></p>
                                    <br />
                                    <form class="shipping-options">
                                        <ul>
                                            ...
                                            <li class="txt-grey-1">Place Order on Hold until:<br />
                                                (Edit your order until released on COB:)
                                                <input type="text" style="margin-left:18px;" class="x-input datepicker" value="3/23/15" size="14">
                                            </li>
                                        </ul>
                                        <ul>
                                            <li class="txt-grey-1">
                                        ...
                                        <ul>
                                            <li class="txt-grey-1" style="height: 30px;">
  ...
  <br />
                    ...
                    <table id="mil-list" style="background:none;">
                        <tbody>
                            <tr class="table-header-bar">
                                <td width="100px"  class="no-border table-header-bar-left"><span class="white">Product Description</span></td>
                                <td width="55px"  align="left" class="no-border"><span class="white">Quantity</span></td>
                                <td  align="center" class="no-border"><span class="white">UOM</span></td>
                                <td class="no-border" align="center" ><span class="white">Status</span></td>
                                <td class="no-border" align="center" ><span class="white">My Price (usd)</span></td>
                                <td class="no-border" align="center" ><span class="white">Ext. Price (usd)</span></td>
                                <td  align="center" class="no-border"><span class="white">Adjustments</span></td>
                                <td  align="center" class="no-border"><span class="white">QTY Shippable</span></td>
                                <td  align="center" class="no-border"><span class="white">QTY Backordered</span></td>
                                <td class="no-border-right table-header-bar-right" align="center"><span class="white">Line Total (usd)</span></td>
                            </tr>
                            <tr>
                                <td><img src="../../images/catalog/products/prod-img-small.jpg"/> <a href="#">Jiffy Padded Mailers, 4&quot; W x 8&quot; L, Size 000, Gold, Satin, Kraft Paper with Paper Fiber Inner Batting, Padded (500 Each/Case) <br />
                                    <br />
                                    xpedx # 23453241</a>
                                    <div id="special-instructions">
                                        <p>Special Instruction: <a href="#">Add</a></p>
                                    </div></td>
                                <td valign="top" align="left"> Job#<br />
                                    12345<br />
                                    <br />
                                    PO#<br />
                                    12345<br />
                            ...
                            <tr class="odd">
                                <td><img  src="../../images/catalog/products/prod-img-small-2.jpg"/> <a href="#">Jiffy Padded Mailers, 4&quot; W x 8&quot; L, Size 000, Gold, Satin, Kraft Paper with Paper Fiber Inner Batting, Padded (500 Each/Case) <br />
                                    <br />
                                    xpedx # 23453241</a>
                                    <div id="special-instructions">
                                ...
                                <td valign="top" align="left"> Job#<br />
                                    ...
                                    12345 </td>
                                <td valign="top" align="center"> Carton </td>
                                <td valign="top" align="left"><a href="#">Order #<br />
                            ...
                            <tr>
                                <td><img src="../../images/catalog/products/prod-img-small-3.jpg"/> <a href="#">Jiffy Padded Mailers, 4&quot; W x 8&quot; L, Size 000, Gold, Satin, Kraft Paper with Paper Fiber Inner Batting, Padded (500 Each/Case) <br />
                                    <br />
                                    xpedx # 23453241</a>
                                    <div id="special-instructions">
                                        <p>Special Instruction: <a href="#">Edit</a></p>
