...
nohup /xpedx/sterling/Foundation/bin/sci_ant.sh -f xpedxCDTBuild.xml cdt_"$ENVIRONMENT"_export -logfile $cdtLogFile &  
echo "Export cdt process started. Below is the log file generated. Press Ctrl+C to exit out of tail..."
