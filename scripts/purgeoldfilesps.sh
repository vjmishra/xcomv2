...
# 
# NOTE THAT THE RETENTION POLICY IS DIFFERENT BETWEEN DEV, ps, and PROD
#
#1- Foundation\Logs
...
#8-/xpedx/logfiles/swcps/
#9-/xpedx/logfiles/smcfsps/

#specify log file to output to. 
LOGFILENAME=/home/share/xpadmin/purgelogs/purgeout_ps_`date +"%Y%m%d-%H%M"`.log
...
#) PROCESS  /xpedx/logfiles/smcfsps/*.log*
Directory='/xpedx/logfiles/smcfsps/'
SearchPattern=log
DaysToRetain=5
purgeoldfiles_StarPattern $Directory $SearchPattern $DaysToRetain $LOGFILENAME
 
#) PROCESS  /xpedx/logfiles/swcps/*.log*
Directory='/xpedx/logfiles/swcps/'
SearchPattern=log
DaysToRetain=5
purgeoldfiles_StarPattern $Directory $SearchPattern $DaysToRetain $LOGFILENAME
