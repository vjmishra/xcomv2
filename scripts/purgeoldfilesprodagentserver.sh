...
#find only files owned by xpbuild or script won't complete. 
find /xpedx/sterling/Foundation/logs/ -user xpbuild -name "*.log*" -type f -mtime +7 -exec rm {} \;
...
Directory='/xpedx/logfiles/swc01/'
SearchPattern=log
DaysToRetain=15
purgeoldfiles_StarPattern $Directory $SearchPattern $DaysToRetain $LOGFILENAME

Directory='/xpedx/logfiles/swc02/'
SearchPattern=log
DaysToRetain=15
purgeoldfiles_StarPattern $Directory $SearchPattern $DaysToRetain $LOGFILENAME
...
#) PROCESS  /xpedx/logfiles/swcprd/*.log*
Directory='/xpedx/logfiles/smcfs01/'
SearchPattern=log
DaysToRetain=15
purgeoldfiles_StarPattern $Directory $SearchPattern $DaysToRetain $LOGFILENAME

Directory='/xpedx/logfiles/smcfs02/'
SearchPattern=log
DaysToRetain=15
purgeoldfiles_StarPattern $Directory $SearchPattern $DaysToRetain $LOGFILENAME
...
find /xpedx/sterling/Foundation/bin/ -name "*.hprof" -type f -size +100000000c -mtime +5 -exec rm {} \; 

# purge the heap dump files > 1GB that are older than 3 days in the Foundation directory
find /xpedx/sterling/Foundation/bin/ -name "*.hprof" -type f -size +1000000000c -mtime +3 -exec rm {} \; 

# purge the heap dump files > 100MB that are older than 3 days in the wldomain directory
find /xpedx/wldomain/ -name "*.hprof" -type f -size +100000000c -mtime +5 -exec rm {} \; 
...
find /xpedx/sterling/Foundation/bin/ -name "*core" -type f -size +1000000000c -mtime +3 -exec rm {} \; 
...
find /xpedx/sterling/Foundation/logs/ -name "*_VERBOSE_*" -type f -size +100000000c -mtime +5 -exec rm {} \; 

# purge the verbose files > 1GB that are older than 3 days in the Foundation directory
find /xpedx/sterling/Foundation/logs/ -name "*_VERBOSE_*" -type f -size +1000000000c -mtime +3 -exec rm {} \; 

# purge the verbose  files > 100MB that are older than 7 days in the wldomain directory
find /xpedx/logfiles/ -name "*_VERBOSE_*" -type f -size +100000000c -mtime +5 -exec rm {} \; 

# purge the verbose files > 1GB that are older than 3 days in the wldomain directory
find /xpedx/logfiles/ -name "*_VERBOSE_*" -type f -size +1000000000c -mtime +3 -exec rm {} \; 
