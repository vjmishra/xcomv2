...
FUNCTION: This script is to be used during the dev database refresh from any other environment(
...
update yfs_customer set EXTN_ORIG_ENVIRONMENT_CODE = 'D3' where (EXTN_ORIG_ENVIRONMENT_CODE = 'T3' OR EXTN_ORIG_ENVIRONMENT_CODE = 'N3');
commit;

update yfs_customer set EXTN_ORIG_ENVIRONMENT_CODE = 'D4' where (EXTN_ORIG_ENVIRONMENT_CODE = 'T4' OR EXTN_ORIG_ENVIRONMENT_CODE = 'N4');
commit;
