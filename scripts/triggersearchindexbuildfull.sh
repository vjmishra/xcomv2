...
echo "Please confirm that you want to trigger the FULL search index build on $HOST_NAME by typing the hostname again:\c"
read Answer
...
if [[ "$HOST_NAME" = "z$Answer" ]];then
	...
	./triggeragent.sh "CATALOG_INDEX_BUILD"
