...
#8-/xpedx/logfiles/swcstg/
#9-/xpedx/logfiles/smcfsstg/

#specify log file to output to. 
LOGFILENAME=/home/share/xpadmin/purgelogs/purgeout_stg_`date +"%Y%m%d-%H%M"`.log
...
#) PROCESS  /xpedx/logfiles/smcfsstg/*.log*
Directory='/xpedx/logfiles/smcfsstg/'
SearchPattern=log
DaysToRetain=5
purgeoldfiles_StarPattern $Directory $SearchPattern $DaysToRetain $LOGFILENAME
 
#) PROCESS  /xpedx/logfiles/swcstg/*.log*
Directory='/xpedx/logfiles/swcstg/'
SearchPattern=log
DaysToRetain=5
purgeoldfiles_StarPattern $Directory $SearchPattern $DaysToRetain $LOGFILENAME
