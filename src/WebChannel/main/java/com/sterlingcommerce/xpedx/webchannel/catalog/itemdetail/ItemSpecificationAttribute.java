...
public enum ItemSpecificationAttribute {
	...
	Alternative_fiber_name(Group.ITEM_SPECS, Integer.MAX_VALUE),
	...
	Color(Group.ITEM_SPECS, Integer.MAX_VALUE),
	Compatibility(Group.ITEM_SPECS, Integer.MAX_VALUE),
	...
	Flap_type(Group.ITEM_SPECS, Integer.MAX_VALUE),
	...
	Thickness(Group.ITEM_SPECS, Integer.MAX_VALUE),
	...
	LEED_Product_category(Group.ENVIRO_SPECS, Integer.MAX_VALUE),
