...
public class XPEDXDraftOrderCopyAction extends DraftOrderCopyAction {
    ...
    public String execute() {
		try {
			// Remove itemMap from Session, when cart change in context, For
			// Minicart Jira 3481
    ...
    @Override
    protected void manipulateMashupInputs(Map<String, Element> mashupInputs) throws CannotBuildInputException {
        ...
        if(orderElem != null ) {
            ...
            if(shipToCustomer!=null) {                
                ...
                if(billToCustomer != null) {
                    ...
                    extnOrderElem.setAttribute("ExtnBillToCustomerID", billToCustomer.getCustomerID());
                }
            }
