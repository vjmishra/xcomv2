/**
 * This is action-sepcific validation class for action saveNewUserInfo for Create User functionality.
 */
...
public class XPEDXSaveNewUserInfoValidation extends AbstractWCFormFieldValidation {
	...
	public void validate(Map parameters, ValidationInfo jsonData,
		...
		if (YFCCommon.isVoid(userIdValue)) {
			...
			jsonData = validateGenLoginid(userIdValue, jsonData);
		}
