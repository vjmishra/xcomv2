...
public class XPEDXGetArticle extends WCMashupAction {
    ...
    public String execute()
    {
        ...
        //Get all the CustomerID's which needs to be included in the query. Only those articles belonging to the CustomerID will be
        //displayed in the UI
    ...
    public List<String> getParentCustomerList(){
    	...
    	try {
            ...
            valueMap.put("/Customer/@OrganizationCode",getWCContext().getStorefrontId());
            valueMap.put("/Customer/@CustomerID",getWCContext().getCustomerId());
    		
    		Element input = WCMashupHelper.getMashupInput("XPEDXParentCustomerList", valueMap, getWCContext().getSCUIContext());
			
    		Object obj = WCMashupHelper.invokeMashup("XPEDXParentCustomerList", input, getWCContext().getSCUIContext());
    ...
    public void setArticleElements(){
    	try{
 			//Element listInput = WCMashupHelper.getMashupAPI("XPEDXArticleList",getWCContext().getSCUIContext());
	...
	/**
	 * @param buyerOrganizationCodeList the buyerOrganizationCodeList to set
	 */
