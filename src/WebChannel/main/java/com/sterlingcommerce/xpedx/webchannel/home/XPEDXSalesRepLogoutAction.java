...
public class XPEDXSalesRepLogoutAction extends Logout {

	private static final Logger LOG = Logger.getLogger(XPEDXSalesRepLogoutAction.class);
	...
	public String execute() {
		...
		CookieUtil.deleteCookie(scuiContext.getRequest(), scuiContext.getResponse(), CookieUtil.SALESREP);
