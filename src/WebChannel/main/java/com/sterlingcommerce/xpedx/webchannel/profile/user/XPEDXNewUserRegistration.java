		...
		public String execute(){
			...
			try
			{
				...
				*/
			    ...
			    Element inputXmlFromMashup =(Element)mashupInputs.get("XPEDXSendNewUserInfoToCSR");
			    Element newUserElement=(Element)inputXmlFromMashup.getElementsByTagName("NewUser").item(0);
