...
public class XPEDXPreviewLogoHeaderAction extends WCAction implements ServletRequestAware {
		...
		public String deletePreviewLogo()
		{
			try 
	    	{
				...
				String filePath = uictx.getServletContext().getRealPath("/") + File.separator + absPreivewLogoDir;
				String customerId = getWCContext().getCustomerId();
		...
		private static final Logger log = Logger.getLogger(XPEDXPreviewLogoHeaderAction.class);
