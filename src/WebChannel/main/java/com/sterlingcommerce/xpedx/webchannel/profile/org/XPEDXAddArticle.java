...
public class XPEDXAddArticle extends WCMashupAction {
	...
	public String getShipToCustomerCustomerID(){
		...
		{
			log.error("There is no customer's customer id is associated for ship to id "+customerId+" setting creating article for ship to id");
	...
	public String getCustomerId() {
		//Document sapCustomerDoc=((Document)wcContext.getSCUIContext().getRequest().getSession().getAttribute("sapCustExtnFields"));
