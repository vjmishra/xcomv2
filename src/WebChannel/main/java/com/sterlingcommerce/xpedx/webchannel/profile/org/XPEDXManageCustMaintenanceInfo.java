...
public class XPEDXManageCustMaintenanceInfo extends WCMashupAction {
	...
	public String manageCustMaintenanceInfo() {
		if (log.isDebugEnabled())
			log
					.debug("Class:XPEDXManageCustMaintenanceInfo Method:manageCustMaintenanceInfo STARTS");
		String returnStr = updateCustomerDetails("customer-manageCustMaintenanceInfo");
		if (!"success".equals(returnStr))
			return returnStr;
		if (log.isDebugEnabled())
			log
					.debug("Class:XPEDXManageCustMaintenanceInfo Method:manageCustMaintenanceInfo ENDS");
	...
	private String updateCustomerDetails(String mashupID) {
		if (log.isDebugEnabled())
			log
					.debug("Class:XPEDXManageCustMaintenanceInfo Method:updateCustomerDetails STARTS");
		try {
		...
		if (log.isDebugEnabled())
			log
					.debug("Class:XPEDXManageCustMaintenanceInfo Method:updateCustomerDetails END");
		return "success";
	}
	...
	public void setViewPrices(String vPrices) {
		if("true".equals(vPrices))
			viewPrices= "Y";
	}
	...
	public void setCanOrder(String cOrder) {
		if("true".equals(cOrder))
			canOrder= "Y";
	}
	
	public String getCanViewInventory() {
		return canViewInv;
	}

	public void setCanViewInventory(String cViewInv) {
		if("true".equals(cViewInv))
			canViewInv= "Y";
	}
	
	public String getUseCustomerSKU() {
		return useCustSKU;
	}

	public void setUseCustomerSKU(String uCustSKU) {
		if("true".equals(uCustSKU))
			useCustSKU= "Y";
	}
	*/
	/*public String getUseOrderMultipleUOM() {
		return useOrderMulUOM;
	}

	public void setUseOrderMultipleUOM(String uOrderMulUOM) {
		if("true".equals(uOrderMulUOM))
			useOrderMulUOM= "Y";
	}*/
	
	/*public String getSampleRequestFlag() {
		return sampleRequestFlag;
	}

	public void setSampleRequestFlag(String srFlag) {
		if("true".equals(srFlag))
			sampleRequestFlag= "Y";
	}*/
	
	/*public String getEmailViewInvoices() {
		return emailViewInvoices;
	}

	public void setEmailViewInvoices(String eViewInvoices) {
		if("true".equals(eViewInvoices))
			emailViewInvoices= "Y";
	}
	
	public String getPreviewInvoices() {
		return previewInvoices;
	}

	public void setPreviewInvoices(String pInvoices) {
		if("true".equals(pInvoices))
			previewInvoices= "Y";
	}
	...
	*/
	...
	private static final Logger log = Logger.getLogger(XPEDXManageCustMaintenanceInfo.class);
