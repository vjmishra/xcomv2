...
{
	private static final Logger log = Logger.getLogger(XPEDXGetCustomerOrganizationAction.class);
	...
	public String getGeneralInfo() {
		...
		if (log.isDebugEnabled())
			log
					.debug("Class:GetCustomerOrganizationAction Method:getGeneralInfo STARTS");
		String returnStr = getCustomerDetails("xpedx-customer-getGeneralInformation",
				false);
		...
		if (log.isDebugEnabled())
			log
					.debug("Class:GetCustomerOrganizationAction Method:getGeneralInfo ENDS");
		return returnStr;
	}
	...
	public String getCorporateInfo() {
		...
		if (log.isDebugEnabled())
			log
					.debug("Class:GetCustomerOrganizationAction Method:getCorporateInfo STARTS");
		...
		if (log.isDebugEnabled())
			log
					.debug("Class:GetCustomerOrganizationAction Method:getCorporateInfo ENDS");
		return returnStr;
	}
	...
	public String getPaymentInfo() {
		...
		if (log.isDebugEnabled())
			log
					.debug("Class:GetCustomerOrganizationAction Method:getPaymentInfo STARTS");
		customerId = getWCContext().getSCUIContext().getRequest().getParameter(
				"customerId");
		...
		try {
			...
			if (log.isDebugEnabled())
				log.debug((new StringBuilder()).append(
						"customerOrganizationEle: ").append(
						customerOrganizationEle).toString());
		} catch (Exception ex) {
		...
		if (log.isDebugEnabled())
			log
					.debug("Class:GetCustomerOrganizationAction Method:getPaymentInfo ENDS");
		return "success";
	}
	...
	public String getNewCustomerInfo() {
		...
		if (log.isDebugEnabled())
			log
					.debug("Class:NewCustomerProfileAction Method:getGeneralInfo ENDS");
		return returnStr;
	}
	...
	private String populateChildCustomerList(Object customerObj) {
		...
		if (log.isDebugEnabled())
			log
					.debug("Class:GetCustomerOrganizationAction Method:populateCorporateInfo STARTS");
		parentCustomerKey = SCXmlUtils.getAttribute((Element) customerObj,
				"CustomerKey");
		try {
						...
						if (log.isDebugEnabled())
							log
									.debug((new StringBuilder())
											.append(
													"Class:GetCustomerOrganizationAction Method:populateChildCustomerList")
											.append(
													childCust
		...
		if (log.isDebugEnabled())
			log
					.debug("Class:GetCustomerOrganizationAction Method:populateChildCustomerList ENDS");
		return "success";
	}
	...
	private static final String CUSTOMER_GENERAL_INFO_MASHUP = "customer-getGeneralInformation";
	private static final String CUSTOMER_CORPORATE_INFO_MASHUP = "cust-GetCustomerCorpInfo";
	private static final String CUSTOMER_CHILD_CUSTOMERS_MASHUP = "cust-getCustomerList";
	private static final String CUSTOMER_PAYMENT_INFO_MASHUP = "customer-getPaymentInformation";
	private static final String CUSTOMER_PAYMENT_TYPE_LIST_UTIL_MASHUP = "PaymentTypeListUtil";
	private static final String CUSTOMER_GET_NEW_CUSTOMER = "customer-getNewCustomer";
