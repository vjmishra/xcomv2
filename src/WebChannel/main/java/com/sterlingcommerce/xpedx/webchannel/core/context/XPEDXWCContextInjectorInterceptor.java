...
public class XPEDXWCContextInjectorInterceptor  extends WCContextInjectorInterceptor {
    ...
    */
    ...
    private void logException(ActionInvocation invocation,Exception ex) throws Exception
    {
        ...
        response.sendRedirect("/swc/xpedx/jsp/common/GeneralSystemError.jsp?sfId="+builder.getStorefrontId());//added for EB 2398 - to fetch the SfID from the interceptor to display Color theme in the General System Error page
    }
}
