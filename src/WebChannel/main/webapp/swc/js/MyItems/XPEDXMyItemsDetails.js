...
function qaAddItem(jobId, qty, itemId, itemType, purchaseOrder, itemTypeText){
	...
	//Validate the data
		...
		cAction.innerHTML 		= '<a class="del-quick-add" href="javascript:void(0);" onclick="javascript: qaDeleteRow(\''+rowId+'\');"><input type="image" src="/swc/xpedx/images/icons/12x12_charcoal_x.png" /></a>';
