...
<!--     	&nbsp;&nbsp; -->
    ...
    <s:a href="%{draftOrderDetailsURL}" cssClass="underlink">
      <s:property value='%{value}'/> (<s:property  value="%{#orderLines.getAttribute('TotalNumberOfRecords')}"/>)
    </s:a>
</s:if>
<s:else>
	<s:a href="%{draftOrderDetailsURL}" cssClass="underlink">
...
<p class="grey-mil"><s:property  value="%{#orderDesc.getAttribute('ExtnOrderDesc')}"/></p>