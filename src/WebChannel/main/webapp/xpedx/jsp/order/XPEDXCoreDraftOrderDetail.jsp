	                    	...
	                    	<tr>
						 	...
						 	<tr>
						 		...
						 		<br/>
                					...
                					<s:else>
                						<s:set id="OrderMultipleUom" name="OrderMultipleUom"  value="%{#OrderMultipleQtyFromSrc.substring(#OrderMultipleQtyFromSrc.indexOf('|')+1,#OrderMultipleQtyFromSrc.length())}"/>
                						<s:set id="OrderMultipleQty" name="OrderMultipleQty"  value="%{#OrderMultipleQtyFromSrc.substring(0,#OrderMultipleQtyFromSrc.indexOf('|'))}"/>
						 				<s:if test='%{#OrderMultipleQtyFromSrc !=null && #OrderMultipleQtyFromSrc !="" &&  #OrderMultipleQty!="1" }'>						 			
