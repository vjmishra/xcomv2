...
<table class="catalog-my-price-availability">
	...
	<s:set name="reqCustomerUOM" value="%{#_action.getPnaReqCustomerUOM()}" />
			...
			<s:if test='%{#lineStatusCodeMsg == "" && #_action.getIsOMError() != "true"}'>
				<tbody>
					...
					<s:if test='%{#qtyTxtBox != null && #qtyTxtBox != 0 && #jsonAvailabilityBalance != null}'>
						...
						<p style="color:<s:property value='%{#jsonAvailabilityMessageColor}'/>;font-size:12px;padding-left:10px">
							<strong><s:property value="#xpedxutil.formatQuantityForCommas(#jsonAvailabilityBalance)"/> <s:property value='%{#jsonUOMDesc}'/> not available</strong>
						</p>
					</s:if>
						...
						<td colspan="3" width="36%" valign="top">
							<table cellpadding="0" cellspacing="0" border="0">
								<s:if test='%{#qtyTxtBox != null && #qtyTxtBox != 0}'>
									<tr>
										<td align="left" style="color:<s:property value='%{#jsonAvailabilityMessageColor}'/>;font-size:12px;">
											<strong style="align:left;"><s:property value='%{#jsonAvailabilityMessage}' /></strong>
										</td>
									</tr>
								</s:if>
								<tr>
								...
								<tr>
									...
									<td class="my-number" align="right">
										...
										<meta name="DCSext.w_x_scr" content="<s:property value='@com.sterlingcommerce.xpedx.webchannel.utilities.XPEDXWCUtils@getFormattedQty(#jsonTotal)' />"></meta>                          	
										<!-- Web Trends tag End -->	
									</td>
			...
			<s:else>
				<s:if test='%{#lineStatusCodeMsg != "" && #_action.getIsOMError() != "true"}'>
					<tr align="center">
						<td>&nbsp;</td>
						<td width="100%">
							<b><font color="red"><s:property value="%{#lineStatusCodeMsg}"/></font></b>
						</td>
					</tr>
				</s:if>	
			</s:else>
