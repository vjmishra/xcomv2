...
'<div id="item-ct">',
 '<tpl for=".">','<dl>','<tpl for="items">','<dd id="{itemkey}" class="itemdiv">',
  ...
  '<td class="add_to_cart"><input type="hidden" name="isEditOrder" id="isEditOrder" value="<s:property value='#isEditOrderHeaderKey'/>"/>',<s:if test='!#guestUser'><s:if test="#isEditOrderHeaderKey == null || #isEditOrderHeaderKey=='' ">
   '<div class="addtocart-btn"><a class="orange-ui-btn" id=\'addtocart_{itemid}\' href="#" onclick=\"javascript:addItemToCart(\'{itemid}\'); return false;\"><span>Add to Cart</span></a></div>',
  </s:if><s:else>
	 '<div class="addtocart-btn"><a class="orange-ui-btn" id=\'addtocart_{itemid}\' href="#" onclick=\"javascript:addItemToCart(\'{itemid}\'); return false;\"><span>Add to Order</span></a></div>',
  </s:else>		
 ...
 '<tpl for=".">','<dl>','<tpl for="items">','<dd id="{itemkey}"  class="itemdiv" style="height:auto;">',
  ...
  '<table class="bottable">','<tr>','<td class="compare_check">',
   ...
   '<tr>','<td class="mill-mfg">{itemtypedesc}</td>',
    '<td class="add_to_cart">',<s:if test='!#guestUser'>'<input type="hidden" name="isEditOrder" id="isEditOrder" value="<s:property value='#isEditOrderHeaderKey'/>"/>',<s:if test="#isEditOrderHeaderKey == null || #isEditOrderHeaderKey=='' ">'<div class="addtocart-btn"><a class="orange-ui-btn" id=\'addtocart_{itemid}\' href="#" onclick=\"javascript:addItemToCart(\'{itemid}\'); return false;\"><span>Add to Cart</span></a></div>',</s:if><s:else>'<div class="addtocart-btn"><a class="orange-ui-btn" id=\'addtocart_{itemid}\' href="#" onclick=\"javascript:addItemToCart(\'{itemid}\'); return false;\"><span>Add to Order</span></a></div>',</s:else>
...
'<div id="item-ct">',
 '<tpl for=".">','<dl>','<tpl for="items">','<dd id="{itemkey}" class="itemdiv" >',
  ...
  '</div>','<div class="contents">',
   ...
   '<div class="clearall">&nbsp;</div>',
   <s:if test='!#guestUser'>'<input type="hidden" name="isEditOrder" id="isEditOrder" value="<s:property value='#isEditOrderHeaderKey'/>"/>',<s:if test="#isEditOrderHeaderKey == null || #isEditOrderHeaderKey==''" >'<div class="addtocart-btn"><a class="orange-ui-btn" id=\'addtocart_{itemid}\' href="#" onclick=\"javascript:addItemToCart(\'{itemid}\'); return false;\"><span>Add to Cart</span></a></div>',</s:if><s:else>'<div class="addtocart-btn"><a class="orange-ui-btn" id=\'addtocart_{itemid}\' href="#" onclick=\"javascript:addItemToCart(\'{itemid}\'); return false;\"><span>Add to Order</span></a></div>',</s:else>
