	...
	<div id="main">
		...
		<div id="homepage-ad-area">
			...
			<!-- Added for EB-1549 Display a Saalfeld advertisement image on the Home page  Starts -->
				...
				<img width="300" height="250" border="0" alt="" src="<s:property value='#wcUtil.staticFileLocation' />/xpedx/images/ad_placeholders/_thumb_25626<s:property value='#wcUtil.xpedxBuildKey' />.jpg"/>
				</s:if>
