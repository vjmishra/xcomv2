...
<!-- link media="all" type="text/css" rel="stylesheet" href="<s:url value='/swc/xpedx/css/home/home<s:property value='#wcUtil.staticFileLocation' />/xpedx/css/theme/ADMIN.css'/>" /-->
<!-- link media="all" type="text/css" rel="stylesheet" href="<s:url value='/swc/xpedx/css/common/notes-list<s:property value='#wcUtil.staticFileLocation' />/xpedx/css/theme/ADMIN.css'/>" /-->
