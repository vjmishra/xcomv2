...
<link href="<s:property value='#wcUtil.staticFileLocation' />/xpedx/css/user/ui.dynatree.css"	rel="stylesheet" type="text/css" id="skinSheet">
...
<script src="<s:property value='#wcUtil.staticFileLocation' />/xpedx/js/SpryTabbedPanels<s:property value='#wcUtil.xpedxBuildKey' />.js"
	...
	document.getElementById("strdiv"+val1).style.display="block";
		...
		//end for XBT 298
		  ...
		  //Checking if two quick links have the same order
			...
			document.getElementById('newAssignedCustomers').value=$('#echoSelection3').text();
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"
		...
		<s:if test='%{#isCustomerNotAdmin == false}'>
			...
			<s:if test="%{!#disableSinceSelfApprover}">
				...
				<s:checkbox tabindex="11" name='buyerAdmin' id='buyerAdmin'	fieldValue="true" value='%{isInUserGroup("BUYER-ADMIN")}'/> Admin</label> 
				<label
