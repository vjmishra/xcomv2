				...
				<tbody>
					...
					<tr>
						<td><b>
							...
							This Privacy Policy as posted on this Website is the sole statement of our privacy policy with respect to this Website, and no summary, modification, restatement or other version thereof, or other privacy statement or policy, in any form, is valid unless we post a new or revised policy to the Website.<br/><br/><br/><br/>
							</td>
							</tr>
						<tr>
						<td style= 'text-align:center'>
					...
					<b>9.	TAXES -</b> Any tax, duty, or other governmental charge now or hereafter levied upon the production, sale, use or shipment of materials ordered or sold hereunder shall be for the Buyer's account.  Such governmental levies are not covered in the Seller's price, unless expressly so stated.<br/><br/><br/>
