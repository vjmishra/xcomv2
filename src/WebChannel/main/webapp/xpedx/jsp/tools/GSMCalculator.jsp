			...
			<div class="container content-container">
				...
				<div id="mid-col-mil">
					<div style="width: 600px;">
						...
						<p>To convert basis weight of a given standard size of paper
							to grams per square meter, multiply its basis weight by 1406.5
							and divide the results by the square area of its basic size.</p>

						<div id="requestform">
							<div class="clearview">&nbsp;</div>


							<form name="eform" method="post" action="GSMCalculator.aspx"
								...
								<table style="width: 600px;" class="form">
									<tbody>
										...
										<tr>
											<td>Basis Weight:</td>
											<td width="385"><input name="bWeight" type="text"
												style="width: 120px;"
										...
										<tr>
											...
											</span> <select name="bSize" size="1" id="bSize">
										...
										<tr>
											<td width="195"><strong>Basis Weight
								...
								<tr>
									<td align="right" class="noBorders-fff" style="border-right:none;"><table
											...
											<tbody>
												...
												<tr>
													<td valign="middle" align="center"
														style="border-left: none; border-top: 1px solid #999; border-right: none; border-bottom: none;"
														class="noBorders-fff">Basic Size</td>
												</tr>
											</tbody>
										</table></td>
						...
						<table style="width: 100%;" class="standard-table">
								...
								<tbody>
								<tr>
									<td colspan="3" style="border-bottom: none;">Convert 17x22, 28lb. Bond paper to grams
										per square meter.</td>
								</tr>
								<tr>
									<td align="right" class="noBorders-fff" style="border-right:none;"><table
