...
<!-- /STUFF --><script type="text/javascript" src="<s:property value='#wcUtil.staticFileLocation' />/xpedx/js/xpedx-new-ui<s:property value='#wcUtil.xpedxBuildKey' />.js" language="javascript"></script>
	<script type="text/javascript" src="<s:property value='#wcUtil.staticFileLocation' />/xpedx/js/rool-weight<s:property value='#wcUtil.xpedxBuildKey' />.js" language="javascript"></script>
				...
				<h1>Roll Weight</h1>
					...
					<div style="width: 600px;">
								...
								<table style="width: 600px;" class="form roll-weight">
									<tbody>
										...
										<tr>
											...
											<td><input name="rDiameter" type="text"
												style="width: 80px;"
												onkeyup="calcPhone('Value',eform.rDiameter);"
												class="x-input right-align" id="rDiameter" /></td>
										</tr>
										<tr>
											<td>Core Diameter (Inches):</td>
											<td><input name="cDiameter" type="text"
												style="width: 80px;" class="x-input right-align"
												id="cDiameter" onkeyup="calcPhone('Value',eform.cDiameter);" /></td>
										</tr>
										<tr>
											<td>&nbsp;Roll Width (Inches):</td>
											<td><span class="no-border-left"> <input
													type="hidden" id="txtstran" name="txtstran" />
											</span> <input name="rWidth" type="text" style="width: 80px;"
												class="x-input right-align" id="rWidth"
												onkeyup="calcPhone('Value',eform.rWidth);" /></td>
										</tr>
										<tr>
											<td>Factor:&nbsp;</td>
											<td class="padding8"><select name="factor" size="1"
												id="factor" class="TextField">
													<option selected="selected" value="">Select factor
														:</option>
													<option value=".018">Antique - .018</option>
													<option value=".020">Vellum Offset - .020</option>
													<option value=".021">Bond - .021</option>
													<option value=".022">Smooth Offset - .022</option>
													<option value=".022">Vellum Bristol Cover - .022</option>
													<option value=".026">Tag and Index - .026</option>
													<option value=".032">C1S Label - .032</option>
													<option value=".033">C2S Cover - .033</option>
													<option value=".030">C1S Cover &amp; Blanks - .030</option>
													<option value=".037">C2S Coated Freesheet - .037</option>
													<option value=".032">Coated Groundwood &amp; SC -
														.032</option>
											</select></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><strong class="red"> <input
													readonly="readonly" name="Answer"
											...
											<tbody>
												<tr>
													<td valign="middle" align="center"
														style="border:none;" class="noBorders-fff">[
														(Roll Dia&sup2;) - (Core Dia&sup2;) ] x Roll Width x Factor</td>
												</tr>
											</tbody>
										</table></td>
						...
						<table style="width: 100%;" class="standard-table">
								...
								<tbody>
								<tr>
									<td colspan="3" align="left" style="border-bottom:none;">Find the weight of roll of
										forms bond paper with a roll diameter of 40 inches, a core
										diameter of 3 inches, and a roll width of 17.5 inches.</td>
								</tr>
								<tr>
									<td align="right" class="noBorders-fff" style="border-right:none; border-bottom:none"><table
											cellspacing="0" cellpadding="0" class="noBorders-fff">
											<tbody>
												<tr>
													<td valign="middle" align="center"
														class="noBorders-fff" style="border:none;">
														[(40x40) - (3x3) ] x 17.5 x .021</td>
												</tr>
											</tbody>
										</table></td>
									<td width="38" valign="middle" class="noBorders-fff" style="border-right:none; border-bottom:none">=</td>
									<td width="228" valign="middle" style="border-bottom:none">585 lbs.</td>
								</tr>
								<tr>
									<td colspan="3" align="left"><strong>Note</strong>: .021
										is the appropriate factor for forms bond paper.</td>
								</tr>
							</tbody>
						</table>
						<div style="width: 100%;" id="table-bottom-bar">
