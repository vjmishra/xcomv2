				...
				<div id="mid-col-mil">
					<div style="width: 600px;">
								...
								<table style="width: 600px;" class="form">
									<tbody>
										<tr>
											...
											<td colspan="3"><input name="Msheets" type="text"
												style="width: 60px;"
												onkeyup="calcPhone('Value',eform.Msheets);" class="x-input"
												id="Msheets" /></td>
										</tr>
										<tr>
											<td>Number of Sheets:<br /></td>
											<td colspan="3"><input name="NumSheets" type="text"
												style="width: 60px;"
												onkeyup="calcPhone('Value',eform.NumSheets);"
												class="x-input" id="NumSheets" /></td>
										</tr>
										<tr>
											<td>&nbsp;</td>
											...
											<td colspan="3"><ul id="cart-actions"
													style="height: auto;">
										...
										<tr>
											...
											<td colspan="3" width="228"><input readonly="readonly"
												name="Answer"
						...
						<table style="width: 100%;" class="standard-table">
								...
								<tbody>
								<tr>
									<td colspan="3" align="left" style="border-bottom: none;">Find the weight of 1,365
										sheets, 25x38, 60lb. 120M Offset paper.</td>
								</tr>
								<tr>
									<td align="right" class="noBorders-fff" style="border-right: none;"><table
											cellspacing="0" cellpadding="0" class="noBorders-fff">
											<tbody>
												<tr>
													<td valign="middle" align="center"
														style="border: none;" class="noBorders-fff">120
														x 1,365</td>
												</tr>
												<tr>
													<td valign="middle" align="center"
