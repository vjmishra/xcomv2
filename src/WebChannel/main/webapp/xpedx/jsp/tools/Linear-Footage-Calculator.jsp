			...
			<div class="container content-container">
				...
				<div id="mid-col-mil">
					<div style="width: 600px;">
						...
						<p>To find the approximate linear footage in a roll of paper,
							multiply the weight of the roll by the square inches of basic
							size by 500. Divide by the sum representing the width of the
							roll, multiplied by the substance or basis weight, times 12.</p>

						<div id="requestform">
							<div class="clearview">&nbsp;</div>


							<form name="eform" method="post" action="sc_papcalclinfoot.aspx"
								id="eform">
								...
								<table style="width: 600px;" class="form">
									<tbody>
										...
										<tr>
											...
											<td colspan="3"><input name="rWeight" type="text"
												style="width: 80px;"
												onkeyup="calcPhone('Value',eform.rWeight);"
												class="x-input right-align" id="rWeight" /></td>
										</tr>
										<tr>
											...
											<td width="270" class="padding8"><input name="wArea"
												type="text" style="width: 80px;" class="x-input right-align"
										...
										<tr>
											<td>Roll Width:<br /></td>
											<td colspan="3" class="padding8"><input name="rWidth"
												type="text" style="width: 80px;" class="x-input right-align"
												id="rWidth" onkeyup="calcPhone('Value',eform.rWidth);" /></td>
										</tr>
										<tr>
											<td>&nbsp;</td>
											<td colspan="3">
						...
						<table style="width: 100%;" class="standard-table">
								...
								<tbody>
								<tr>
									<td colspan="3" align="left" style="border-bottom:none;">Find the footage of a roll
										of basis 50lb. Offset paper, 26&quot; wide and weighing
										100lbs.</td>
								</tr>
								<tr>
									<td align="right" class="noBorders-fff" style="border-right:none;"><table
											...
											<tbody>
												<tr>
													<td valign="middle" align="center"
														style="border:none;" class="noBorders-fff">100
														x (25x38) x 500</td>
												</tr>
												<tr>
													<td valign="middle" align="center"
														style="border-left: medium none; border-top: 1px solid #999; border-right:none;border-bottom:none;"
														class="noBorders-fff">(50x26) x 12</td>
												</tr>
											</tbody>
										</table></td>
									<td width="38" valign="middle" class="noBorders-fff" style="border-right:none;">=</td>
