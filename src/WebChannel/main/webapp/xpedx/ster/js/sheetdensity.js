// JavaScript Document
  ...
  function validatePrompt (Ctrl, PromptStr) {
		...
		function validateForm() {
			...
			CalculateDensity(form.bWeight.value,form.caliper.value);
			return true;
		}

		function CalculateDensity(bWeight,caliper) {
			var	Density = (bWeight/caliper);
			document.eform.Answer.value = formatnumber(Density,2);
		}
