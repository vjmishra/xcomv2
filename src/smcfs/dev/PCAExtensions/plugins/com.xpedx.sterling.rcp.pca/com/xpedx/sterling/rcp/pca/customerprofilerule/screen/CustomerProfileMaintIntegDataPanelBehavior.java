...
//			((XPXCustomerProfileRuleEditor)YRCDesktopUI.getCurrentPart()).showBusy(true);
	...
	public void update() {
		...
		// password needs to be encrypted when stored in DB
		String password = YRCXmlUtils.getAttributeValue(eleUpdate, "/Customer/Extn/@ExtnUserPwdParam");
		String encrypted = EncryptionUtils.encrypt(password);
		YRCXmlUtils.setAttributeValue(eleUpdate, "/Customer/Extn/@ExtnUserPwdParam", encrypted);
