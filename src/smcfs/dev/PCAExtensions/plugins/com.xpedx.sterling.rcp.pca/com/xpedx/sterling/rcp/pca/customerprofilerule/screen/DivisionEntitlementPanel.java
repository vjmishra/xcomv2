...
public class DivisionEntitlementPanel extends Composite implements
		IYRCComposite {

	private Composite pnlRoot = null;

	private DivisionEntitlementPanelBehavior myBehavior;

	private YRCWizardBehavior wizBehavior;

	public static final String FORM_ID = "com.xpedx.sterling.rcp.pca.customerprofilerule.screen.DivisionEntitlementPanel"; // @jve:decl-index=0:
	...
	private Label lblDivisionEntitlementFlag;
	...
	private Button divisionEntitlementFlag;
	
	private Text divisionEntitlement;
	...
	public DivisionEntitlementPanel(Composite parent, int style,
		...
		myBehavior = new DivisionEntitlementPanelBehavior(this, inputObject,
				FORM_ID, parentObj);
...
//				if(HideControlsList.contains(control)){
	...
	private void createCustomerProfileInfoPnl() {
		...
		if(!("C".equals(suffixType))||("S".equals(suffixType))){
...
//		gridData2.horizontalIndent = 80;
		...
		chkCsr1EmailConfirmationFlag.setVisible(false);
		...
		lblCsr1EmailConfirmationFlag.setVisible(false);
		...
		chkCsr2EmailConfirmationFlag.setVisible(false);
		...
		lblCsr2EmailConfirmationFlag.setVisible(false);
		...
		chkSalesRepEmailConfirmationFlag.setVisible(false);
		...
		lblSalesRepEmailConfirmationFlag.setVisible(false);
		...
		lblMaxOrderAmount.setVisible(false);
		...
		txtMaxOrderAmount.setVisible(false);
		...
		stxtMaxOrderCurrency.setVisible(false);
		...
		lblMinOrderAmount.setVisible(false);
		...
		txtMinOrderAmount.setVisible(false);
		...
		stxtMinOrderCurrency.setVisible(false);
		...
		lblSmallOrderFee.setVisible(false);
		...
		txtSmallOrderFee.setVisible(false);
		...
		stxtSmallOrderCurrency.setVisible(false);
		...
		lblShipComplete.setVisible(false);
		...
		txtShipComplete.setVisible(false);
		...
		chkOrderUpdateFlag.setVisible(false);
		...
		lblOrderUpdateFlag.setVisible(false);
		...
		chkShipToOverrideFlag.setVisible(false);
		...
		lblShipToOverrideFlag.setVisible(false);
		...
		lblCurrencyCode.setVisible(false);
		...
		txtCurrencyCode.setVisible(false);
	}
...
//		gridData2.horizontalIndent = 80;
	...
	//	gridData4.widthHint = 300;
		...
		//Added By Manas
		/*divisionEntitlementFlag = new Button(pnlCustomerProfileInfo, SWT.CHECK);
		divisionEntitlementFlag.setText("");
		divisionEntitlementFlag.setVisible(true);
		divisionEntitlementFlag.setData("yrc:customType", "Label");
		divisionEntitlementFlag.setLayoutData(gridData1);
		divisionEntitlementFlag.setData("name", "divisionEntitlementFlag");*/
		
		addTab(gridData1,"dummyOrderUpdateFlag");

		lblDivisionEntitlementFlag = new Label(pnlCustomerProfileInfo, SWT.LEFT);
		lblDivisionEntitlementFlag.setText("Apply Division Entitlement");
		lblDivisionEntitlementFlag.setLayoutData(gridData2);
		lblDivisionEntitlementFlag.setData("name", "lblDivisionEntitlementFlag");
		lblDivisionEntitlementFlag.setVisible(true);
		
		
		divisionEntitlement = new Text(pnlCustomerProfileInfo, 2048);
		divisionEntitlement.setText("");
		...
		txtAddressLine1.setVisible(false);
		...
		txtAddressLine2.setVisible(false);
		...
		lblAddressLine3.setVisible(false);
		...
		txtAddressLine3.setVisible(false);
		...
		lblCountryCode.setVisible(false);
		...
		txtCountryCode.setVisible(false);
		...
		lblAttentionName.setVisible(false);
		...
		txtAttentionName.setVisible(false);
		...
		lblLocationId.setVisible(false);
		...
		txtLocationId.setVisible(false);
		...
		lblCustomerStatus.setVisible(false);
		...
		txtCustomerStatus.setVisible(false);
	}
...
//		gridData2.horizontalIndent = 80;
		...
		lblCustomerDivision.setVisible(false);
		...
		txtCustomerDivision.setVisible(false);
		...
		lblShipFromBranch.setVisible(false);
		...
		txtShipFromBranch.setVisible(false);
		...
		lblCustomerClass.setVisible(false);
		...
		txtCustomerClass.setVisible(false);
		...
		lblServiceOptmizationCode.setVisible(false);
		...
		txtServiceOptmizationCode.setVisible(false);
		...
		lblPrimarySalesRep.setVisible(false);
		...
		txtPrimarySalesRep.setVisible(false);
		...
		lblInvoiceDistMethod.setVisible(false);
		...
		txtInvoiceDistMethod.setVisible(false);
	}
...
//		tbd.setTargetBinding("XPXCustomerOut:/Customer/Extn/@ExtnBrandCode");
	...
	public DivisionEntitlementPanelBehavior getPageBehavior() {
		return myBehavior;
	}
