 ...
 */
public class XPXShowListOfUsersPanel extends XPXPaginationComposite implements IYRCComposite{
	
	private Composite pnlRoot = null;
    private XPXShowListOfUsersPanelBehaviour myBehavior;
	private Element elePageInput;
	private Group pnlResults;
	Table tblResults;
	public Element eleSelected;
	private String isMil;
    public static final String FORM_ID = "com.xpedx.sterling.rcp.pca.sharedTasks.shiptolookup.XPXShowListOfUsersPanel";

	public XPXShowListOfUsersPanel(Composite parent, int style, Element inputObject) {
		super(parent, style);
		elePageInput = (Element) inputObject;
		isMil = elePageInput.getAttribute("MIL");
		initialize();
		setBindingForComponents();
        myBehavior = new XPXShowListOfUsersPanelBehaviour(this, FORM_ID, elePageInput);
	}
	...
	private void createPnlResults() {
		...
		createTblResults();
		super.createPaginationLinks(pnlResults, XPXShowListOfUsersPanelBehaviour.PAGINATION_STRATEGY_FOR_SEARCH);
	}
