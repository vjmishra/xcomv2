...
public class XPXShowItemListDetailPanel extends XPXPaginationComposite implements IYRCComposite {

	private Composite pnlRoot = null;
    private XPXShowItemListDetailPanelBehaviour myBehavior;
	private Element elePageInput;
	private Group pnlResults;
	Table tblResults;
	public Element eleSelected;
	private String isMil;
    public static final String FORM_ID = "com.xpedx.sterling.rcp.pca.sharedTasks.shiptolookup.XPXShowItemListDetailPanel";

	public XPXShowItemListDetailPanel(Composite parent, int style, Element inputObject) {
		super(parent, style);
		elePageInput = (Element) inputObject;
		isMil = elePageInput.getAttribute("MIL");
		initialize();
		setBindingForComponents();
        myBehavior = new XPXShowItemListDetailPanelBehaviour(this, FORM_ID, elePageInput);
	}
    ...
    private void setBindingForComponents() {
        ...
        colBindings[0].setColumnBinding("Item_ID");
        colBindings[0].setSortReqd(true);   
        
        colBindings[1] = new YRCTblClmBindingData();
        colBindings[1].setAttributeBinding("@Desc");
        colBindings[1].setColumnBinding("Item_Name");
        colBindings[1].setSortReqd(true);
        colBindings[1].setSortReqd(true);
        
        bindingData.setSortRequired(true);
        bindingData.setSourceBinding("XPEDXMyItemsListList:/XPEDXMyItemsListList/XPEDXMyItemsList/XPEDXMyItemsItemsList/XPEDXMyItemsItems");
        ...
        //Changing the font color of the selected Item
        bindingData.setColorProvider(new IYRCTableColorProvider() {
        	
     public String getColorTheme(Object element, int chkShowInvalidETradingIDOnly) {
    	 
    	 System.out.println("The column test is"+YRCXmlUtils.getString((Element) element));
				
    	 if("2001020".equals(YRCXmlUtils.getAttribute((Element) element, "ItemId")))
			{
	...
	private void createPnlResults() {
		...
		createTblResults();
		super.createPaginationLinks(pnlResults, XPXShowItemListDetailPanelBehaviour.PAGINATION_STRATEGY_FOR_SEARCH);
	}
	private void createPnlTitleHolder() {
		XPXUtils.addGradientPanelHeader(pnlResults, "ItemListDetail", true);
	}
	...
	private void createTblResults() {
		...
		clmArticleName.setText("Item#");
		clmArticleName.setWidth(25);//TODO: set appropriate width
		
		TableColumn clmStartDate = new TableColumn(tblResults, SWT.NONE);
		clmStartDate.setText("Item Description");
		clmStartDate.setWidth(300);//TODO: set appropriate width
