 ...
 *
 */
package com.xpedx.sterling.rcp.pca.customerprofilerule.editor;
...
public class XPXCustomerProfileRuleEditor extends YRCEditorPart {

	private XPXOrderLinesWizardBehavior pnlRootBehavior;
	public static final String ID_EDITOR = "com.xpedx.sterling.rcp.pca.customerprofilerule.editor.XPXCustomerProfileRuleEditor";
    private String titleKey = "XPXCustomerProfileRuleEditor_title";
    ...
    public Composite createPartControl(Composite parent, String taskID) {
        ...
        customerId = YRCXmlUtils.getAttribute(e, "CustomerID");
        
        pnlRoot = new CustomerProfileMaintenance(parent, SWT.NONE,input);
        pnlRoot.setData(YRCConstants.YRC_OWNERPART, this);
        
        setPartName(getTitleKey()+" "+customerId);
