...
AS
   SELECT DISTINCT(OH.ORDER_HEADER_KEY),
      ...
      YCC.CODE_SHORT_DESCRIPTION as STATUS,
...
CREATE OR REPLACE FORCE VIEW XPX_CUST_VIEW (CUSTOMER_ID,
  CUSTOMER_NAME, CUSTOMER_KEY, ENTERPRISE_CODE, EXTN_CUST_STORE_NO,
  ROOT_CUSTOMER_KEY, USER_ID, FIRST_NAME, LAST_NAME,
  SHIP_TO_ADDR_LINE_1, SHIP_TO_ADDR_LINE_2, SHIP_TO_ADDR_LINE_3,
  SHIP_TO_CITY, SHIP_TO_STATE, SHIP_TO_ZIP_CODE, EXTN_ZIP4,
  SHIP_TO_COUNTRY, EMAILID, SAP_EXTN_CUST_LINE_ACCNO_FLAG,
  SAP_EXTN_CUST_LINE_COMM_FLAG, SAP_EXTN_CUST_LINE_ACC_LBL,
  SAP_EXTN_CUST_LINE_SEQNO_FLAG, SAP_EXTN_CUST_LINE_PONO_FLAG,
  SAP_EXTN_CUST_LINE_FIELD1_FLAG, SAP_EXTN_CUST_LINE_FIELD1_LBL,
  SAP_EXTN_CUST_LINE_FIELD2_FLAG, SAP_EXTN_CUST_LINE_FIELD2_LBL,
  SAP_EXTN_CUST_LINE_FIELD3_FLAG, SAP_EXTN_CUST_LINE_FIELD3_LBL)
                                  AS
