...
TRIM(ShipTo.EXTN_SHIP_FROM_BRANCH)||'_'||TRIM(ShipTo.EXTN_ENVIRONMENT_CODE) AS SHIP_TO_DIVISION_ID,
ORG.ORGANIZATION_NAME AS DIVISION_NAME,
...
ShipTo.EXTN_SUFFIX_TYPE='S' AND
trim(ORG.ORGANIZATION_KEY) = TRIM(ShipTo.EXTN_SHIP_FROM_BRANCH)||'_'||TRIM(ShipTo.EXTN_ENVIRONMENT_CODE) AND ORG.IS_NODE='Y';
