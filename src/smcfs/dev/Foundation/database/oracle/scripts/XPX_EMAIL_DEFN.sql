...
Insert into XPX_EMAIL_DEFN (EMAIL_XSL_PATH,EMAIL_TYPE,EMAIL_TO_XPATH,EMAIL_CC_XPATH,EMAIL_BCC_XPATH) values ('../extensions/global/template/email/XPX_Order_Confirmation.xsl','ORDER_PENDING_APPROVAL_EMAIL','/Order/CustomerContactList/CustomerContact/@ToEmailID','/Order/CustomerContactList/CustomerContact/@CCEmailID,/Order/Extn/@ExtnAddnlEmailAddr','');

Insert into XPX_EMAIL_DEFN (EMAIL_XSL_PATH,EMAIL_TYPE,EMAIL_TO_XPATH,EMAIL_CC_XPATH,EMAIL_BCC_XPATH) values ('../extensions/global/template/email/XPX_Order_Confirmation.xsl','ORDER_APPROVED_EMAIL','/Order/CustomerContactList/CustomerContact/@EmailID','/Order/CustomerContactList/CustomerContact/@CCEmailID,/Order/Extn/@ExtnAddnlEmailAddr','');

Insert into XPX_EMAIL_DEFN (EMAIL_XSL_PATH,EMAIL_TYPE,EMAIL_TO_XPATH,EMAIL_CC_XPATH,EMAIL_BCC_XPATH) values ('../extensions/global/template/email/XPX_Order_Confirmation.xsl','ORDER_REJECTED_EMAIL','/Order/CustomerContactList/CustomerContact/@ToEmailID','/Order/CustomerContactList/CustomerContact/@CCEmailID','');
