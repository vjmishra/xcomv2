...
<table width="600" border="0" align="center" cellpadding="2" cellspacing="2">
  ...
  <tr>
    <td><img src="logo-email.jpg" width="210" height="79" alt="xpedx" longdesc="http://www.xpedx.com" /></td>
  </tr>
  <tr>
      ...
      <tr>
        <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><table width="" border="0">
          ...
          <tr>
            <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">Thank you for shopping at  &lt;branded&gt;.com. Please review the details of your order below.                 <span >&lt;</span><a href="#" style="color:#000;">Click Here</a>&gt; to review this order on &lt;branded&gt;.com.</td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><table width="100%" border="0">
              ...
              <tr>
                ...
                <td width="32%" style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">&lt;CustLocation&gt;</td>
              </tr>
              ...
              <tr>
                ...
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">&lt;OrderStatus&gt;</td>
              ...
              <tr>
                ...
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><xsl:value-of select="./@CustCustPONo"/></td>
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">City, State:</td>
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><xsl:value-of select="PersonInfoShipTo/@City"/>,<xsl:value-of select="PersonInfoShipTo/@State"/></td>
              </tr>
              <tr>
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">Placed By:</td>

                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><xsl:value-of select="./@Createuserid"/></td>
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">Zip:</td>
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><xsl:value-of select="PersonInfoShipTo/Extn/@ExtnZip4"/></td>
              </tr>
              <tr>
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">Order Date:</td>
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;" >
              ...
              <tr>
                ...
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><xsl:value-of select="Instructions/Instruction[@InstructionType='HEADER']/@InstructionText" /></td>
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">Shipping Comments:</td>

                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">&lt;shippingcomments&gt;</td>
              </tr>
              <tr>
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">&#160;</td>
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">&#160;</td>
          ...
          <tr>
            <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
