							...
							<tr>
								<td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">
									<table width="" border="0">
										...
										<tr>				
											<td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">
											<h4>Action Required - B2B Order Received:</h4>
												The following order has been received in Call Center. Please review the Order Status below to determine if this order requires further action.	
											</td>
										</tr>
										<tr>
										...
										<tr>
											<td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">
												<table width="100%" border="0">
													...
													<tr>
														<td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">Order By:</td>
														<td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">
											...
											<td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">
												<table width="100%" border="0" cellpadding="0" cellspacing="0">
													<tr>
														...
														<td width="57" style="font-family: Arial, Geneva, sans-serif;font-size:11px; color:#fff;  background-color:#818181; padding:0px 2px; ">UOM Qty </td>
