  ...
  <tr>
      ...
      <tr>
        <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><table width="" border="0">
          ...
          <tr>
            <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">Thank you for shopping at <xsl:value-of select="@EnterpriseCode"/>.com. This notification is to let you know your order has been shipped. Please review the details of your order below. <a href="#" style="color:#000;">Click Here</a> to review this order on <xsl:value-of select="@EnterpriseCode"/>.com </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><table width="100%" border="0">
              ...
              <tr>
                ...
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">Shipped</td>
