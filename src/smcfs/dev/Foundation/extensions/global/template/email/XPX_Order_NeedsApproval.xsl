		...
		<HTML>
			...
			<table width="100%" border="0" align="center" cellpadding="2" cellspacing="2">
				...
				<tr>
					...
					<td>
					The following order requires your attention.Click here to review this order on <xsl:value-of select="Order/@SellerOrganizationCode"/>.com. Thank you for your buisness!
