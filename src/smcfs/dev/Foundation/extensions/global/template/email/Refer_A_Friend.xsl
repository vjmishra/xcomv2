	...
	<xsl:template match="User">
		...
		<html>
			...
			<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
			  <tr>
				<td height="44"><img src="xpedx_r_rgb_lo.jpg" width="216" height="69" alt="xpedx" longdesc="http://www.xpedx.com" /></td>
			  </tr>
			  <tr>
					  ...
					  <tr>
						<td style="font-family: Arial, Geneva, sans-serif;font-size:12px; border:solid 1px #818181;color:#000;padding:0px 2px; "> 
						  <table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr>
							  <td width="45%" rowspan="8" style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><div align="center"><img name="" src="xpedx_r_rgb_lo.jpg" width="216" height="69" alt="" /></div></td>
