  ...
  <tr>
      ...
      <tr>
        <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><table width="" border="0">
          ...
          <tr>
            <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">Thank you for shopping at <xsl:value-of select="@EnterpriseCode"/>.com. One or more items within your order has been placed on backorder. Please review the details of your order below. <a href="#" style="color:#000;">Click Here</a> to review this order on <xsl:value-of select="@EnterpriseCode"/>.com </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;"><table width="100%" border="0">
              ...
              <tr>
                ...
                <td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">BackOrder</td>
