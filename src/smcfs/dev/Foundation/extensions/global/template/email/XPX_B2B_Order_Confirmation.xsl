							...
							<tr>
								<td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">
									<table width="" border="0">
										...
										<tr>
											<td style="font-family: Arial, Geneva, sans-serif;font-size:12px; color:#000;">
												This message is to confirm we have received your electronic order in our <xsl:value-of select="./@SellerOrganizationCode"/>.com ordering system. Please review the details of your order below.                 
												<span ></span>
