...
<xsl:template name="applyStyle">
	...
	<xsl:template match="Order">
		...
		<xsl:variable name="shipQty" >
			<xsl:value-of select="Order//Extn/@ExtnReqShipOrdQty" />
		</xsl:variable>
				...
				<table>
					...
					<tr>
						<td>
							<table cellpadding="4">
								<tr>
								<xsl:if test = 'Order/@ReqDeliveryDate!=""'>
									<td valign="top"><span class="labelText"> Estimated Delivery Date: </span></td></xsl:if>
									<td valign="top" style="padding-right:30px;">
										<xsl:choose>
					...
					<td style="padding-bottom:15px;">
							<table cellpadding="4">
								<tr>
									...
									<td valign="top"><xsl:value-of select="Order/Instructions/Instruction[@InstructionType='HEADER']/@InstructionText" /></td>
								</tr>
							</table>
						</td>
					</tr>
			  ...
			  <tr>
								...
								<thead>								
					             <xsl:choose>
									...
									<th bgcolor="#003399" class="align-center" valign="top">Extended<br/>Price&#160;(USD)</th>	
									 ...
									 <tr>
									 <th bgcolor="#003399" style="padding-right:0px;"></th>
									<th bgcolor="#003399" class="align-left" valign="top" style="padding-left:4px;padding-right:10px;">Ordered Quantity</th>
									...
									<th bgcolor="#003399" class="align-left" valign="top" style="padding-left:0px;padding-right:0px;"></th>
									 <th bgcolor="#003399" class="align-center" valign="top">My Price&#160;(USD)</th>
									 <th bgcolor="#003399" class="align-left" valign="top" style="padding-left:0px;padding-right:10px;"></th>																	 
									<th bgcolor="#003399" class="align-center" valign="top">Extended Price&#160;(USD)</th>
									 </tr>
									 </xsl:otherwise>
								</xsl:choose>
				...
				<xsl:if test = '@lineOrderNO!=""' >					
					...
					<tr> 
						...
						<xsl:otherwise><td>Line Account#:&#160;</td></xsl:otherwise>
						</xsl:choose>
				 ...
				 <td class="align-right"><xsl:choose>
					...
					<td class="totalLabelText">Shipping and Handling:</td>
						<xsl:choose>
							<xsl:when test='Order/@MaxOrderStatus="1100.5700" or Order/@MaxOrderStatus="1100.5950" or Order/@MaxOrderStatus="1100.5750"' >
								<td>												
								<td class="admin">$<xsl:value-of select="Order/Extn/@ExtnTotalOrderFreight"/></td>
								</td>
							</xsl:when>
						<xsl:otherwise>
							<td>
								...
								<xsl:choose>								
									...
									<td>
										<td class="align-right">
											<span class="tbd"><xsl:value-of select='format-number(Order/Extn/@ExtnTotalOrderValue,"$#,###,###,##0.00")'></xsl:value-of></span>
										</td>
									</td>
									</xsl:otherwise>
								</xsl:choose>	
