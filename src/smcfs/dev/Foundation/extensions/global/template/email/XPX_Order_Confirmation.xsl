		...
		<HTML>
			...
			<tbody>
				...
				<tr>
					...
					<td class="addWidth"><xsl:value-of select='format-number(Extn/@ExtnReqShipOrdQty,"#")'/>&#160;<xsl:value-of select="substring(OrderLineTranQuantity/@UOMDescription,3,4)"/></td>
					<td class="align-right">
					<xsl:if test='$viewPricesFlag ="Y"'>
						<xsl:choose>
				...
				<tr>
					...
					<td class="addWidth"><xsl:value-of select='format-number(Extn/@ExtnReqBackOrdQty,"#")'/>&#160;<xsl:value-of select="substring(OrderLineTranQuantity/@UOMDescription,3,4)"/></td>
					<td class="right"></td>
					<td class="right"></td>
					</xsl:if>
                     </xsl:if>
