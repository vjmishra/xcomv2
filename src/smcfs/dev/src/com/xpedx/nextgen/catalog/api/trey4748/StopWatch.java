/*
 * DELETE ME!
 * COPY/PASTED FROM apache commons-lang library: http://grepcode.com/file_/repo1.maven.org/maven2/commons-lang/commons-lang/2.3/org/apache/commons/lang/time/StopWatch.java/?v=source
 * to avoid modifying library dependencies for temporary logigng for eb-4748
 * Under NO circumstances should this be used for anything other than logging related to eb-4748
 */
...
public class StopWatch {
    ...
    // we don't need these for our logging purposes and would like to avoid pulling in the DurationFormatUtils dependency
//    /**
