 ...
 * 
 */
public class InvokeManageEntitlementRuleAPI {
	...
	static {
		yfcLogCatalog = YFCLogCategory
				.instance(InvokeManageEntitlementRuleAPI.class);
		try {
	...
	public Document invokeManageEntitlementRule(YFSEnvironment env,
