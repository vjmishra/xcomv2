...
public class XPXStockCheckReqRespAPI implements YIFCustomApi
{
	...
	{
		/*
		 * <xpedxStockCheckWSRequest xmlns:ns1="https://b2b.xpedx.com/webservices/">
         *   <SenderCredentials>
         *         <UserEmail></UserEmail>
         ...
         *               <BuyerID></BuyerID>
         *           <StockCheckRequest>
         *               <eTradingPartnerID></eTradingPartnerID>   
         *              <Items>
         *                 <Item>
         *                      <IndexID></IndexID>
         *                      <xpedxPartNumber></xpedxPartNumber>
		...
		if(isLoginValid)
		{
		  ...
		  catch(Exception e)
		  {
		    ...
		    if(pAndArequestInputDocument.getDocumentElement().getTagName().equalsIgnoreCase("PriceAndAvailabilityRequest"))
		    {
		    Document pAndAResponseDocument = api.executeFlow(env, "XPXPandACallsForStockCheckService", pAndArequestInputDocument);
	                              ...
	                              YFSException, RemoteException, DOMException, YIFClientCreationException,NullPointerException, YFSException, Exception
	{
         ...
         *  <RootErrorInfo>
           ...
           <PriceAndAvailabilityResponse>
                     <sTransactionStatus>P</sTransactionStatus> 
                     <sEnvironmentId>A</sEnvironmentId> 
                     <sCustomerEnvironmentId>AD</sCustomerEnvironmentId> 
                     <sCompany>XX</sCompany> 
                     <sCustomerBranch>23</sCustomerBranch> 
                     <sCustomerNumber>100035</sCustomerNumber> 
                     <sShipToSuffix>000</sShipToSuffix> 
                     <sOrderBranch>23</sOrderBranch> 
                     <sHeaderStatusCode>00</sHeaderStatusCode> 
                     <aItems>
                             <aItem>
                                    <sLineNumber>045</sLineNumber> 
                                    <sLegacyProductCode>220434</sLegacyProductCode> 
                                    <sRequestedQtyUOM>A_SHT</sRequestedQtyUOM> 
                                    <sRequestedQty>500</sRequestedQty> 
                                    <sPricingUOM>A_M</sPricingUOM> 
                                    <sPriceCurrencyCode>CAD</sPriceCurrencyCode> 
                                    <sUnitPricePerPricingUOM>15.1865</sUnitPricePerPricingUOM> 
                                    <sUnitPricePerRequestedUOM>15.1865</sUnitPricePerRequestedUOM> 
                                    <sExtendedPrice>7.59</sExtendedPrice> 
                                    <sItemCost>9.995</sItemCost> 
                                    <sCostCurrencyCode>CAD</sCostCurrencyCode> 
                                    <aWarehouseLocations>
                                             <aWarehouseLocation>
                                                   <sWarehouse>23</sWarehouse> 
                                                   <sAvailableQty>19500</sAvailableQty> 
                                                   <sNumberOfDays>0</sNumberOfDays> 
                                                   <sOnOrderQty>0</sOnOrderQty> 
                                             </aWarehouseLocation>
                                             <aWarehouseLocation>
                                                   <sWarehouse>43</sWarehouse> 
                                                   <sAvailableQty>3000</sAvailableQty> 
                                                   <sNumberOfDays>1</sNumberOfDays> 
                                                   <sOnOrderQty>0</sOnOrderQty> 
                                             </aWarehouseLocation>
                                   </aWarehouseLocations>
                                   <sLineStatusCode>00</sLineStatusCode> 
                            </aItem>
                   </aItems>
               </PriceAndAvailabilityResponse>
		...
		Element aItemsFromPandA = (Element) pAndAResponseDocRoot.getElementsByTagName("aItems").item(0);
		
		// Creating the item element in the stock check response
		if(aItemsFromPandA!=null)
		{
			NodeList itemListFromPandA = aItemsFromPandA.getElementsByTagName("aItem");
			...
			if(itemListFromPandA.getLength()>0)
			{
				...
				for(int i=0; i<itemListFromPandA.getLength(); i++)
				{
					  ...
					  indexID.setTextContent(SCXmlUtil.getXpathElement(itemElementFromPandA,"./sLineNumber").getTextContent());
					  item.appendChild(indexID);
					  
					  Element xpedxPartNumber = stockCheckResponseDocument.createElement("xpedxPartNumber");
					  xpedxPartNumber.setTextContent(SCXmlUtil.getXpathElement(itemElementFromPandA,"./sLegacyProductCode").getTextContent());
					  item.appendChild(xpedxPartNumber);
					  ...
					  quantity.setTextContent(SCXmlUtil.getXpathElement(itemElementFromPandA,"./sRequestedQty").getTextContent());
					  item.appendChild(quantity);
					  ...
					  String baseUOM = SCXmlUtil.getXpathElement(itemElementFromPandA,"./sRequestedQtyUOM").getTextContent();
					  String pricingUom = SCXmlUtil.getXpathElement(itemElementFromPandA,"./sPricingUOM").getTextContent();
					  String convertedBaseUnitOfMeasure = null;
					  
					  convertedBaseUnitOfMeasure = XPXUtils.replaceOutgoingUOMFromLegacy(env, envtId+"_"+baseUOM, xpedxPartNumber.getTextContent(), buyerID.getTextContent(), eTradingID.getTextContent());
					  ...
					  Document getItemDetailsOutputDoc = getItemDetails(env,SCXmlUtil.getXpathElement(itemElementFromPandA,"./sLegacyProductCode").getTextContent());
					 ...
					 // Element wareHouseLocations = (Element) itemElementFromPandA.getElementsByTagName("aWarehouseLocations").item(0);
					  
					  Element wareHouseLocations = SCXmlUtil.getXpathElement(itemElementFromPandA, "./aWarehouseLocations");
					  
				      NodeList wareHouseLocationsList =  wareHouseLocations.getElementsByTagName("aWarehouseLocation");	  
				      
				      if(wareHouseLocationsList.getLength()>0)
				      {
				    	  for(int m=0; m<wareHouseLocationsList.getLength();m++)
				    	  {
				    		  ...
				    		  if(m==0)
				    		  {
								  ...
								  sameDayDesc.setTextContent(SCXmlUtil.getXpathElement(wareHouseLocation,"./sWarehouse").getTextContent());
								  item.appendChild(sameDayDesc);
				    			  
				    			  Element sameDayQuantity = stockCheckResponseDocument.createElement("SameDayQuantity");
				    			  sameDayQty = SCXmlUtil.getXpathElement(wareHouseLocation,"./sAvailableQty").getTextContent();
				    		  ...
				    		  if(m==1)
				    		  {
				    			  ...
				    			  nextDayQty = SCXmlUtil.getXpathElement(wareHouseLocation,"./sAvailableQty").getTextContent();
				    		  ...
				    		  if(m==2)
				    		  {
				    			  ...
				    			  twoDayQty = SCXmlUtil.getXpathElement(wareHouseLocation,"./sAvailableQty").getTextContent();
				    ...
				    (Integer.parseInt(quantity.getTextContent()) > (Integer.parseInt(sameDayQty)+Integer.parseInt(nextDayQty)+ Integer.parseInt(twoDayQty))))
				     {					   
					  ...
					  Element XPXItemExtnElement = (Element)getXPXItemBranchListOutputDocRoot.getElementsByTagName(XPXLiterals.E_XPX_ITEM_EXTN).item(0);
						...
						totalPrice.setTextContent(SCXmlUtil.getXpathElement(itemElementFromPandA,"./sExtendedPrice").getTextContent());
						item.appendChild(totalPrice);
						...
						unitPrice1.setTextContent(SCXmlUtil.getXpathElement(itemElementFromPandA,"./sUnitPricePerRequestedUOM").getTextContent()+"/"+pricingUom);
						item.appendChild(unitPrice1);
						
						if(!SCXmlUtil.getXpathElement(itemElementFromPandA,"./sUnitPricePerRequestedUOM").getTextContent().
								equals(SCXmlUtil.getXpathElement(itemElementFromPandA,"./sUnitPricePerPricingUOM").getTextContent()))
						{	
						   unitPrice2.setTextContent(SCXmlUtil.getXpathElement(itemElementFromPandA,"./sUnitPricePerPricingUOM").getTextContent()+"/"+convertedBaseUnitOfMeasure);
						   item.appendChild(unitPrice2);
						}
						...
						for(int b=0; b<uomList.getLength();b++)
						{
						       ...
						       // uomCode1.setTextContent(uomElement.getAttribute("UnitOfMeasure"));
						        ...
						        uomDescription1.setTextContent("UOMDescription");
	...
	private Document createPandARequestInputDocument(YFSEnvironment env, Element stockCheckInputDocRoot) throws Exception
	{
		...
		Document pAndARequestInputDoc = YFCDocument.createDocument("PriceAndAvailabilityRequest").getDocument();
		...
		Element sSourceIndicator = pAndARequestInputDoc.createElement("sSourceIndicator");
		sSourceIndicator.setTextContent(B2BSourceIndicator);
		
		Element sEnvironmentId = pAndARequestInputDoc.createElement("sEnvironmentId");
		sEnvironmentId.setTextContent(envtId);
		
		Element sCustomerEnvironmentId = pAndARequestInputDoc.createElement("sCustomerEnvironmentId");
		sCustomerEnvironmentId.setTextContent(customerEnvtId);
				
	    Element sCompany = pAndARequestInputDoc.createElement("sCompany");
	    sCompany.setTextContent(companyCode);
	    
	    Element sCustomerBranch = pAndARequestInputDoc.createElement("sCustomerBranch");
	    sCustomerBranch.setTextContent(shipFromBranch);
	    
	    Element sCustomerNumber = pAndARequestInputDoc.createElement("sCustomerNumber");
	    sCustomerNumber.setTextContent(legacyCustomerNumber);
	    
	    Element sOrderBranch = pAndARequestInputDoc.createElement("sOrderBranch");
	    ...
	    Element aItems = pAndARequestInputDoc.createElement("aItems");
	    ...
	    if(stockCheckItemsElement!=null)
	    {
	    	...
	    	if(stockCheckItemList.getLength()>0 && stockCheckItemList.getLength()<=200)
	    	{
	    		...
	    		for(int i=0; i<stockCheckItemList.getLength(); i++)
	    		{
	    			...
	    			Element aItem = pAndARequestInputDoc.createElement("aItem");
	    			
	    			Element sLineNumber = pAndARequestInputDoc.createElement("sLineNumber");
	    			sLineNumber.setTextContent(SCXmlUtil.getXpathElement(itemElement,"./IndexID").getTextContent());
	    			
	    			Element sLegacyProductCode = pAndARequestInputDoc.createElement("sLegacyProductCode");
	    			...
	    			Element sRequestedQtyUOM = pAndARequestInputDoc.createElement("sRequestedQtyUOM");
	    			Element sRequestedQty = pAndARequestInputDoc.createElement("sRequestedQty");
